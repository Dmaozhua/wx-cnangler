...
dimensionWeights: {
  ...
  results: [
    ...
    },
    {
        ...
        equip: "购买一些小众、独特的钓具和拟饵，满足你的实验需求。例如，不同形状和颜色的拟饵，以及各种新型的钓组配件。"
    },
    {
        title: "佛系天尊（Casual）",
    ...
    },
    {
        ...
        equip: "购买具有数据记录和分析功能的智能钓具，方便你进行实验和数据收集。同时，准备多种不同类型的拟饵和钓组，满足实验的需求。"
    },
    {
...
const tianqi = {
  ...
  results: [
      ...
      },
      {
          ...
          equip: "配备一个多功能的天气监测设备，如智能手表或气象仪。准备不同类型的拟饵，以应对不同天气下鱼的口味变化。"
      },
      {
...
const dongji = {
          ...
          options: [
              {
                  ...
                  resultKey: [['Nature', 6], ['Heal', 4]],
                  icon: "🌄"
              },
              {
                  text: "朋友组队邀请，觉得一群人抛竿很热闹",
                  resultKey: [['Social', 5], ['Explore', 5]],
                  icon: "👥"
              },
              {
                  text: "看钓鱼比赛视频，羡慕钓手精准控饵的高光时刻",
                  resultKey: [['Compete', 5], ['Achieve', 5]],
                  icon: "🏆"
              }
          ]
      },
          ...
          options: [
              {
                  ...
                  resultKey: [['Nature', 5], ['Ritual', 5]],
                  icon: "🎣"
              },
              {
                  text: "用新研发的钓组组合钓获目标鱼，验证了自己的思路",
                  resultKey: [['Control', 6], ['Explore', 4]],
                  icon: "🔬"
              },
              {
                  text: "朋友圈晒鱼获后收获20+点赞评论",
                  resultKey: [['Social', 4], ['Achieve', 6]],
                  icon: "❤️"
              }
          ]
      },
          ...
          options: [
              {
                  ...
                  resultKey: [['Heal', 7], ['Ritual', 3]],
                  icon: "🍵"
              },
              {
                  text: "复盘操作细节，一定要找出问题所在",
                  resultKey: [['Control', 6], ['Compete', 4]],
                  icon: "📝"
              },
              {
          ...
          options: [
              {
                  ...
                  resultKey: [['Nature', 8], ['Ritual', 2]],
                  icon: "🐟"
              },
              {
                  text: "装备参数（钓重/感度）能否支撑挑战更大目标鱼",
                  resultKey: [['Compete', 7], ['Control', 3]],
                  icon: "⚙️"
              },
              {
                  text: "是否有钓友群推荐的高性价比款，避免踩雷",
                  resultKey: [['Social', 6], ['Heal', 4]],
                  icon: "💬"
              }
          ]
      },
          ...
          options: [
              {
                  ...
                  resultKey: [['Ritual', 7], ['Heal', 3]],
                  icon: "📅"
              },
              {
                  text: "每月探索1个新水域，记录不同环境的鱼群规律",
                  resultKey: [['Explore', 6], ['Nature', 4]],
                  icon: "🗺️"
              },
              {
                  text: "根据比赛日程调整作钓计划，针对性训练",
                  resultKey: [['Compete', 7], ['Achieve', 3]],
                  icon: "📆"
              }
          ]
      },
          ...
          options: [
              {
                  ...
                  resultKey: [['Ritual', 7], ['Nature', 3]],
                  icon: "🌇"
              },
              {
                  text: "写钓获总结，分析拟饵/天气/水情的关联",
                  resultKey: [['Explore', 6], ['Control', 4]],
                  icon: "📝"
              },
              {
                  text: "在钓鱼社区发Vlog，配文字'今天又被鱼上了一课'",
                  resultKey: [['Social', 5], ['Heal', 5]],
                  icon: "🎥"
              }
          ]
      }
  ...
  dimensionWeights: {
      Nature: 1.25,       // 自然连接（对水域生态的感知与融入）
      Compete: 1.34,      // 竞技驱动（挑战与超越的渴望）
      Heal: 1.35,         // 疗愈需求（通过作钓获得情绪修复）
      Social: 1.05,       // 社交归属（群体互动带来的满足）
      Explore: 1.35,     // 探索欲（对新水域/新方法的好奇）
      Ritual: 1.25,      // 仪式感（规律性行为带来的安全感）
      Control: 1.15,     // 掌控欲（通过技术控制结果的需求）
      Achieve: 1.78      // 成就认可（外部肯定带来的价值感）
  },
  results: [
      {
          ...
          equip: "推荐迷彩涂装的轻量化钓竿（如2.1米ML调），搭配仿生物饵（如鲱鱼型米诺）。钓箱选择可折叠款，减少对环境的干扰。"
      },
      {
          ...
          equip: "选择高感度竞技竿（如2.4米M调，碳布等级40T+），搭配磁力刹车轮（精准控制抛投距离）。必备电子秤+量鱼尺，记录每尾鱼的'战斗数据'。"
      },
      {
          ...
          equip: "选择多场景通用竿（如2.1米L调，兼顾翘嘴/鲈鱼），搭配快拆式饵盒（方便展示新饵）。必备防水手机袋，记录探钓过程实时分享。"
      },
      {
          ...
          equip: "选择经典款钓具（如达瓦某传承系列），避免频繁更换装备。饵盒按'常用顺序'固定摆放，收竿时用软布仔细擦拭每支拟饵。"
      },
      {
          ...
          equip: "选择可调节参数的钓组（如倒钓组+不同重量铅坠），搭配带拉力显示的渔轮。必备温度计+水质测试笔，精确掌握作钓环境数据。"
      },
      {
          ...
          equip: "选择易上手的入门装备（如1.8米UL调套装），多备'友好型'饵（如缓沉VIB，降低挂底率）。钓箱里常备小零食，营造'户外茶话会'氛围。"
      },
      {
          ...
          equip: "选择多调性竿包（容纳L-MH调多种竿子），饵盒按鱼种分类（鳜鱼区/翘嘴区/鳡鱼区）。必备防水笔记本，记录每种鱼的'首次相遇'细节。"
      },
      {
...
const zhexue = {
  ...
  resultKey: [['Adaptability', 6], ['Patience', 4]], // 适应力 + 耐心
  icon: "🔧"
  },
  {
  text: "观察雨丝角度与水面涟漪，推测鱼群可能下潜深度",
  resultKey: [['Observation', 7], ['Empathy', 3]], // 观察力 + 共情力
  icon: "👀"
  },
  {
  text: "打开手机查近 3 年同期天气鱼获记录，对比后决定是否继续",
  resultKey: [['Reflection', 5], ['Control', 5]], // 复盘力 + 掌控欲
  icon: "📊"
  }
  ]
  },
  ...
  resultKey: [['Patience', 8], ['Ritual', 2]], // 耐心 + 仪式感
  icon: "🕯️"
  },
  {
  text: "拆解所有失败抛投动作，用手机录视频对比教学演示",
  resultKey: [['Reflection', 6], ['Control',4]], // 复盘力 + 掌控欲
  icon: "📱"
  },
  {
  text: "把新到的水面系饵绑上，笑着说 ' 试试玄学饵说不定爆口 '",
  resultKey: [['Openness', 7], ['Empathy', 3]], // 开放度 + 共情力
  icon: "🎨"
  }
  ]
  },
  ...
  resultKey: [['Empathy', 6], ['Observation', 4]], // 共情力 + 观察力
  icon: "📸"
  },
  {
  text: "用软尺精确测量体长，对比记录册确认是否破个人纪录",
  resultKey: [['Control', 7], ['Reflection', 3]], // 掌控欲 + 复盘力
  icon: "📏"
  },
  {
  text: "坐在岸边看鱼游走，想 ' 它今天应该能给鱼宝宝带顿大餐了 '",
  resultKey: [['Empathy', 5], ['Patience', 5]], // 共情力 + 耐心
  icon: "🐟"
  }
  ]
  },
  ...
  resultKey: [['Openness', 8], ['Adaptability', 2]], // 开放度 + 适应力
  icon: "🚶"
  },
  {
  text: "提前联系当地钓友请教标点，强调 ' 要尊重水域的脾气 '",
  resultKey: [['Observation', 5], ['Empathy', 5]], // 观察力 + 共情力
  icon: "📞"
  }
  ]
  },
  ...
  resultKey: [['Control', 7], ['Patience', 3]], // 掌控欲 + 耐心
  icon: "⏰"
  },
  {
  text: "观察他的抛投节奏 + 饵落水点，总结 ' 原来深浅交界处才是关键 '",
  resultKey: [['Observation', 6], ['Reflection', 4]], // 观察力 + 复盘力
  icon: "🔍"
  },
  {
  text: "过去请教经验，说 ' 能分享是缘分，鱼群又不是我家的 '",
  resultKey: [['Openness', 5], ['Empathy', 5]], // 开放度 + 共情力
  icon: "🤝"
  }
  ]
  },
  ...
  resultKey: [['Control', 6], ['Adaptability', 4]], // 掌控欲 + 适应力
  icon: "🔄"
  },
  {
  text: "用它钓岸边障碍区，心想 ' 老伙计说不定能创造新纪录 '",
  resultKey: [['Openness', 7], ['Ritual', 3]], // 开放度 + 仪式感
  icon: "🎣"
  },
  {
  text: "把它收进纪念盒，写标签 '2021 年首条鲈鱼就是用你钓的 '",
  resultKey: [['Ritual', 8], ['Empathy', 2]], // 仪式感 + 共情力
  icon: "🎁"
  }
  ]
  },
  ...
  resultKey: [['Reflection', 7], ['Control', 3]], // 复盘力 + 掌控欲
  icon: "✍️"
  },
  {
  text: "坐在钓位看夕阳，想 ' 今天没鱼也挺好，风里有芦苇的味道 '",
  resultKey: [['Patience', 6], ['Empathy', 4]], // 耐心 + 共情力
  icon: "🌇"
  },
  {
  text: "给新手钓友发消息：' 明天来我常去的标点，我带你 '",
  resultKey: [['Openness', 5], ['Adaptability', 5]], // 开放度 + 适应力
  icon: "💌"
  }
  ]
  }
  ...
  dimensionWeights: {
  Patience: 1.7, // 耐心：等待与坚持
  Adaptability: 1.7, // 适应力：灵活调整
  Observation: 1.9, // 观察力：捕捉细节
  Reflection: 1.05, // 复盘力：总结优化
  Empathy: 1.25, // 共情力：理解他者（鱼 / 环境 / 钓友）
  Ritual: 1.9, // 仪式感：过程的神圣性
  Openness: 1.6, // 开放度：接纳新可能
  Control: 1.35 // 掌控欲：追求确定性
  },
  results: [
  {
  ...
  equip: "推荐慢调竿（如 L 调直柄竿）+ 软质握把，配合仿生饵（如 T 尾鱼），让你在长时间作钓中保持舒适，也更贴近鱼群的自然觅食节奏。"
  },
  {
  ...
  equip: "选择高感度竿（如 ML 调枪柄竿）+ 透明鱼线，搭配反应饵（如 VIB），帮你更清晰感知水下结构变化，强化观察 - 调整的神经链路。"
  },
  {
  ...
  equip: "选择参数明确的专业装备（如标注 '20Lb 碳线适配 ' 的水滴轮）+ 带数据记录功能的智能渔获尺，帮你更系统地积累钓鱼数据库。"
  },
  {
  ...
  equip: "推荐轻质碳素竿（如 UL 调直柄竿）+ 天然配色饵（如橄榄绿软虫），减少对环境的 ' 入侵感 '，让你更融入自然对话。"
  },
  {
  ...
  equip: "选择多功能竿（如中通竿）+ 多类型饵盒（包含水面系 / 悬浮系 / 沉底系），满足你 ' 什么都想试试 ' 的探索欲，同时保持装备的灵活性。"
  },
  {
  ...
  equip: "选择有年代感的经典装备（如复古涂装的纺车轮）+ 刻有个人标记的饵盒，这些 ' 有故事 ' 的工具能帮你更好地守护属于自己的钓鱼仪式。"
  },
  {
  ...
  equip: "选择可自定义参数的智能装备（如可调节卸力值的电子水滴轮）+ 经典款与创新款混合饵包，满足你既追求精准又渴望创新的双重需求。"
  },
  {
...
const airForce = {
      ...
      options: [
        {
          ...
          resultKey: [['Resultoriented', 8], ['Techexploration', 2]],
          icon: "🎯"
        },
        {
          text: "希望有鱼咬钩就行（'哪怕小奶鲈也行'）",
          resultKey: [['Processenjoy', 7], ['Natureconnection', 3]],
          icon: "🌿"
        },
        {
          text: "无所谓，去户外透气就行（'空军也当郊游'）",
          resultKey: [['Socialrelax', 6], ['Selfacceptance', 4]],
          icon: "👥"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Techexploration', 7], ['Resultoriented', 3]],
          icon: "🔧"
        },
        {
          text: "蹲下来观察水纹/昆虫（'可能鱼在更深层'）",
          resultKey: [['Natureconnection', 6.5], ['Growthlearning', 3.5]],
          icon: "🔍"
        },
        {
          text: "拍张天空照发朋友圈（'空军但云很好看'）",
          resultKey: [['Processenjoy', 6], ['Socialrelax', 4]],
          icon: "📸"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Growthlearning', 7], ['Techexploration', 3]],
          icon: "📝"
        },
        {
          text: "重点讲沿途趣事（'虽然没鱼，但遇到只水獭'）",
          resultKey: [['Processenjoy', 6.5], ['Natureconnection', 3.5]],
          icon: "🦦"
        },
        {
          text: "自嘲'又给鱼交保护费了'（配哭笑脸表情包）",
          resultKey: [['Selfacceptance', 7], ['Socialrelax', 3]],
          icon: "😂"
        }
      ]
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          resultKey: [['Natureconnection', 6], ['Mentalresilience', 4]],
          icon: "🌡️"
        },
        {
          text: "不重要（'本来就为放松，有没有鱼都行'）",
          resultKey: [['Processenjoy', 7], ['Selfacceptance', 3]],
          icon: "🧘"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Growthlearning', 8], ['Techexploration', 2]],
          icon: "🔬"
        },
        {
          text: "整理钓点环境照片（'这棵老柳树下很适合下次'）",
          resultKey: [['Natureconnection', 7], ['Processenjoy', 3]],
          icon: "🌳"
        },
        {
          text: "约钓友喝奶茶吐槽（'今天我们集体空军'）",
          resultKey: [['Socialrelax', 5], ['Selfacceptance', 5]],
          icon: "🍵"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Resultoriented', 6], ['Techexploration', 4]],
          icon: "💪"
        },
        {
          text: "为他高兴（'他能钓到说明这钓点有鱼'）",
          resultKey: [['Mentalresilience', 9], ['Natureconnection', 1]],
          icon: "🎉"
        },
        {
          text: "觉得没必要比较（'钓鱼又不是比赛'）",
          resultKey: [['Selfacceptance', 6.5], ['Socialrelax', 3.5]],
          icon: "🙅"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Techexploration', 7], ['Growthlearning', 3]],
          icon: "📚"
        },
        {
          text: "换个风景更好的钓点（'上次的山景很美'）",
          resultKey: [['Natureconnection', 6], ['Processenjoy', 4]],
          icon: "🏞️"
        },
        {
  ...
  dimensionWeights: {
    Resultoriented: 1.4,      // 结果导向（重视鱼获）
    Processenjoy: 1.3,        // 过程享受（享受过程）
    Growthlearning: 1.25,     // 成长学习（从空军中学习）
    Mentalresilience: 1.7,    // 心态韧性（情绪管理）
    Natureconnection: 1.35,   // 自然连接（环境互动）
    Socialrelax: 1.15,         // 社交属性（社交意义）
    Selfacceptance: 1.7,     // 自我接纳（接受不完美）
    Techexploration: 1.35     // 技术探索（改进技术）
  },
  results: [
    {
      ...
      equip: "推荐高精度微调钓竿（如MH调快调竿）+ 多速比渔轮（5.2:1-7.1:1），满足你对'精准控制'的需求。搭配不同克重的铅头钩（5g-14g），方便你实验不同水层。"
    },
    {
      ...
      equip: "选择轻量化钓组（UL调软竿+2000型渔轮），降低体力消耗。搭配仿生饵（如雷蛙、米诺），既符合自然规律，又能增加与环境的互动感。"
    },
    {
      ...
      equip: "选择性价比高的入门级钓具（如200-500元套装），避免装备压力影响社交体验。必备便携折叠椅+保温箱（装零食和冰饮），打造'移动社交据点'。"
    },
    {
      ...
      equip: "推荐可替换导环的模块化钓竿（如1节竿体+3种导环），方便实验不同抛投效果。搭配带数据记录功能的智能渔轮（记录抛投距离、收线速度），为你的'科研'提供精准数据。"
    },
    {
      ...
      equip: "选择防紫外线涂装的钓竿（减少对鱼群的视觉干扰）+ 透明鱼线（降低警惕性）。必备温度计+水流速测量仪（如手持流速计），辅助你更精准感知环境。"
    },
    {
      ...
      equip: "选择握把带防滑硅胶的钓竿（增加握感舒适）+ 纺车轮（操作简单减少挫败感）。必备偏光镜（保护眼睛）+ 防晒袖（降低身体不适），让作钓全程保持舒适状态。"
    },
    {
      ...
      equip: "选择专业级钓竿（如日本进口碳布）+ 陶瓷导环渔轮（减少摩擦），满足你对'极致性能'的需求。但建议保留1套'入门老装备'，提醒自己'钓鱼的快乐不在装备'。"
    },
    {
      title: "综合平衡者（多维度均衡）",
...
const personality = {
  ...
  resultKey: [['Goalclarity', 7], ['Resultorientation', 3]],
  icon: "📝"
  },
  {
  text: "大致想 ' 能遇到就好 ' 但更期待惊喜",
  resultKey: [['Environmentaladaptability', 6], ['Patiencethreshold', 4]],
  icon: "✨"
  },
  {
  text: "完全没目标，享受抛投过程就满足",
  resultKey: [['Selfregulation', 8], ['Emotionalstability', 2]],
  icon: "🎣"
  }
  ]
  },
  ...
  resultKey: [['Strategyflexibility', 6], ['Frustrationtolerance', 4]],
  icon: "⚡"
  },
  {
  text: "静坐观察水面 5 分钟，复盘抛投轨迹",
  resultKey: [['Patiencethreshold', 7], ['Environmentaladaptability', 3]],
  icon: "🔍"
  },
  {
  text: "掏出零食喝水，哼歌调整呼吸节奏",
  resultKey: [['Emotionalstability', 8], ['Selfregulation', 2]],
  icon: "🧃"
  }
  ]
  },
  ...
  resultKey: [['Resultorientation', 6], ['Goalclarity', 4]],
  icon: "🎉"
  },
  {
  text: "冷静控鱼，确认安全后才露出笑容",
  resultKey: [['Emotionalstability', 7], ['Frustrationtolerance', 3]],
  icon: "😌"
  },
  {
  text: "拍张照就放生，继续专注作钓",
  resultKey: [['Environmentaladaptability', 8], ['Selfregulation', 2]],
  icon: "🌿"
  }
  ]
  },
  ...
  {
  text: "立刻检查自己装备，考虑升级",
  resultKey: [['Strategyflexibility', 7], ['Resultorientation', 3]],
  icon: "🔧"
  },
  {
  text: "礼貌夸赞，继续按自己节奏作钓",
  resultKey: [['Patiencethreshold', 6], ['Emotionalstability', 4]],
  icon: "🙂"
  },
  {
  text: "分享自己上次钓大鱼的故事活跃气氛",
  resultKey: [['Selfregulation', 8], ['Environmentaladaptability', 2]],
  icon: "💬"
  }
  ]
  },
  ...
  resultKey: [['Goalclarity', 7], ['Strategyflexibility', 3]],
  icon: "📊"
  },
  {
  text: "回想哪个标点可能漏了鱼群",
  ...
  {
  text: "坚持完成原计划，拒绝临时变动",
  resultKey: [['Goalclarity', 6], ['Frustrationtolerance', 4]],
  icon: "🚫"
  },
  {
  text: "带齐备用装备，边去边查新钓点信息",
  resultKey: [['Strategyflexibility', 7], ['Environmentaladaptability', 3]],
  icon: "📱"
  },
  {
  text: "立刻出发，觉得换环境更有趣",
  ...
  resultKey: [['Emotionalstability', 7], ['Selfregulation', 3]],
  icon: "⏳"
  },
  {
  text: "设置勿扰模式，专注作钓结束再处理",
  resultKey: [['Patiencethreshold', 8], ['Frustrationtolerance', 2]],
  icon: "🔇"
  }
  ]
  }
  ...
  dimensionWeights: {
  Goalclarity: 1.4, // 对钓获目标的明确程度
  Resultorientation: 1.3, // 对实际钓获结果的重视程度
  Patiencethreshold: 1.3, // 持续无收获时的耐受时长
  Environmentaladaptability: 1.2, // 应对环境变化的调整能力
  Emotionalstability: 1.49, // 情绪波动的幅度与频率
  Selfregulation: 1.15, // 主动调整状态的意识与方法
  Strategyflexibility: 1.7, // 改变钓法 / 装备的决策速度
  Frustrationtolerance: 1.75 // 面对失败时的心理恢复能力
  },
  results: [
  {
  ...
  equip: "推荐高感度软调竿（如 L 调直柄竿），配合缓降型拟饵（如沉水铅笔），帮助你更细腻感知水下变化，保持作钓节奏。"
  },
  {
  ...
  equip: "选择带线杯计数器的智能轮（如 Shimano Ci4+），配合防水记录板，实时记录抛投次数 / 水深等数据，满足你的精算需求。"
  },
  {
  ...
  equip: "推荐多节便携竿（如 Daiwa Steez Aird），搭配模块化饵盒，方便快速切换钓组，契合你随时调整的需求。"
  },
  {
  ...
  equip: "选择快调硬竿（如 M 调枪柄竿）配合远投轮，方便快速切换标点；携带 5-8 种不同泳层拟饵（米诺 / VIB / 德州钓组），满足高频调整需求。"
  },
  {
  ...
  equip: "选择握感舒适的人体工学竿（如 G.Loomis IMX-Pro），搭配缓降型拟饵（如倒吊钓组），减少操作疲劳，帮助维持情绪稳定。"
  },
  {
  ...
  equip: "推荐中调竿（如 F 调直柄竿）配合匀速收线拟饵（如摇摆米诺），既保证控鱼能力，又能维持稳定作钓节奏。"
  },
  {
  ...
  equip: "选择超轻量竿（如 UL 调直柄竿）配合仿生饵（如软虫），减少操作负担；携带防水相机，记录作钓中的自然瞬间。"
  },
  {
  title: "综合平衡者（四维度均衡型）",
...
const luresGearTest = {
      ...
      resultKey: [['Performance',6], ['Innovation',4]],
      icon: "📏"
      },
      {
      text: "品牌经典系列 + 握把人体工学设计",
      resultKey: [['Brand',7], ['Experience',3]],
      icon: "🏷️"
      },
      {
      text: "涂装配色 (潘通色号)+ 竿身流线弧度",
      resultKey: [['Aesthetic',6], ['Personaltaste',4]],
      icon: "🎨"
      }
      ]
      },
      ...
      resultKey: [['Performance',5], ['Community',5]],
      icon: "📊"
      },
      {
      text: "选择常购品牌的季节限定款",
      resultKey: [['Brand',6], ['Innovation',4]],
      icon: "🆕"
      },
      {
      text: "被饵体造型 / 荧光色吸引 + 符合个人审美",
      resultKey: [['Aesthetic',7], ['Personaltaste',3]],
      icon: "✨"
      }
      ]
      },
      ...
      resultKey: [['Performance',6], ['Practical',4]],
      icon: "🔍"
      },
      {
      text: "选择使用过的熟悉品牌",
      ...
      resultKey: [['Performance',5], ['Innovation',5]],
      icon: "🔬"
      },
      {
      text: "经典款经过时间验证更可靠",
      resultKey: [['Brand',6], ['Community',4]],
      icon: "🕰️"
      },
      {
      text: "看哪个设计更契合个人风格",
      ...
      {
      text: "升级同型号更高参数版本",
      resultKey: [['Performance',5], ['Practical',5]],
      icon: "⬆️"
      },
      {
      text: "继续购买原品牌同系列",
      resultKey: [['Brand',8], ['Experience',2]],
      icon: "🔄"
      },
      {
      text: "换外观更潮流的新款",
      ...
      resultKey: [['Performance',6], ['Community',4]],
      icon: "📢"
      },
      {
      text: "品牌历史故事 + 经典款使用心得",
      resultKey: [['Brand',5], ['Experience',5]],
      icon: "📖"
      },
      {
      ...
      {
      text: "相信朋友的长期使用经验",
      resultKey: [['Community',5], ['Experience',5]],
      icon: "🤝"
      },
      {
      text: "先看实物图片是否符合审美",
      resultKey: [['Aesthetic',5], ['Personaltaste',5]],
      icon: "📸"
      }
      ]
      }
      ...
      dimensionWeights: {
          Performance: 1.05, // 性能参数敏感度
          Brand: 1.1, // 品牌忠诚度
          Aesthetic: 1.05, // 外观设计偏好度
          Practical: 3, // 实用性优先级
          Innovation: 1.45, // 新技术接受度
          Experience: 1.25, // 使用体验关注度
          Community: 1.3, // 社群影响力
          Personaltaste: 1.35 // 个人审美独特性
      },
      results: [
      {
      ...
      equip: "推荐高模量碳布（如 46T 以上）+ 陶瓷导环的专业竿，搭配带数据记录功能的智能渔轮（可记录抛投距离 / 收线速度），拟饵选择有明确下沉速度标注的精准款。"
      },
      {
      title: "品牌信徒（Brand 主导）",
      ...
      equip: "选择目标品牌的旗舰经典款（如某品牌 20 周年纪念竿），搭配同品牌的标志性拟饵（如经典米诺），渔轮选择品牌口碑款（经多年市场验证的型号）。"
      },
      {
      ...
      equip: "推荐限量配色竿（如与知名画家联名款），拟饵选择造型独特的艺术饵（如抽象雕塑感 VIB），渔轮选金属漆工艺款，竿包搭配同色系防水时尚包。"
      },
      {
      ...
      equip: "选择全富士导环（易更换）+EVA 握把（耐脏耐磨）的通用竿，拟饵选经典通用型（如 5cm 米诺），渔轮选金属机身（抗腐蚀）的入门旗舰款。"
      },
      {
      ...
      equip: "推荐纳米树脂碳布竿（如某品牌 X-7 系列），搭配智能渔轮（带咬口震动提醒），拟饵选择带 3D 全息鳞片的仿生款（最新光学诱鱼技术）。"
      },
      {
      ...
      equip: "选择高密度 EVA 握把（吸汗防滑）+ 轻量化竿体（重心靠后）的舒适竿，拟饵选重量分布均匀的平衡款，渔轮选多轴承（顺滑度高）的人体工学款。"
      },
      {
      ...
      equip: "选择近期社群热议款（如某款被 10 + 大 V 推荐的新竿），拟饵选钓友群投票 TOP3 的 ' 爆钓饵 '，渔轮选本地钓场常见的 ' 场霸款 '。"
      },
      {
      ...
      equip: "选择独立设计师品牌的限量款（如某工作室手工竿），拟饵选小众造型（如透明软虫 + 自定义色膏染色），渔轮选复古机械款（带手动泄力调节）。"
      },
      {
      title: "理性感性平衡者（多维度均衡）",
...
const fishingSpotStrategyTest = {
          ...
          resultKey: [['Experience', 6], ['Risk', 4]], // 经验依赖 + 风险偏好
          icon: "🎣"
          },
          {
          text: "沿岸边慢走 10 分钟，观察水草密度 / 深浅交界线 / 倒树位置",
          resultKey: [['Environment', 7], ['Intuition', 3]], // 环境感知 + 直觉判断
          icon: "🌿"
          },
          {
          text: "先找附近钓友闲聊，询问「今天口怎么样？」「哪里出鱼？」",
          resultKey: [['Information', 8], ['System', 2]], // 信息收集 + 系统分析
          icon: "💬"
          }
          ]
          },
          {
          id: 2,
          text: "发现水面有零星鱼星但无明确鱼道时，你会？",
          options: [
          {
          text: "按老习惯选深浅交接处下竿，相信「鱼必藏于此」",
          resultKey: [['Experience', 5], ['Conservative', 5]], // 经验依赖 + 保守策略
          icon: "🔄"
          },
          {
          text: "用不同长度的竿子分段试钓，从近岸到离岸 50 米逐步排查",
          resultKey: [['Explore', 7], ['Risk', 3]], // 主动探索 + 风险偏好
          icon: "🚤"
          },
          {
          text: "打开导航 APP 标记鱼星位置，结合卫星地图分析水下地形",
          resultKey: [['System', 6], ['Information', 4]], // 系统分析 + 信息收集
          icon: "🗺️"
          }
          ]
          },
          ...
          {
          text: "直接下竿，大不了空军就当探路",
          resultKey: [['Risk', 7], ['Explore', 3]], // 风险偏好 + 主动探索
          icon: "🔥"
          },
          {
          text: "先观察半小时：看有没有鱼跳 / 水鸟盘旋 / 漂浮物流向",
          resultKey: [['Environment', 6], ['Intuition', 4]], // 环境感知 + 直觉判断
          icon: "🕵️"
          },
          {
          text: "掏出手机查该水域历史鱼获记录（钓鱼 APP / 论坛帖子）",
          resultKey: [['Information', 5], ['System', 5]], // 信息收集 + 系统分析
          icon: "📱"
          }
          ]
          },
          ...
          resultKey: [['Intuition', 6], ['Environment', 4]], // 直觉判断 + 环境感知
          icon: "💡"
          },
          {
          text: "先试钓友推荐的位置，再试自己选的位置对比效果",
          resultKey: [['Explore', 7], ['System', 3]], // 主动探索 + 系统分析
          icon: "⚖️"
          },
          {
          text: "折中选择两者中间区域，降低试错风险",
          resultKey: [['Conservative', 8], ['Experience', 2]], // 保守策略 + 经验依赖
          icon: "🛡️"
          }
          ]
          },
          ...
          resultKey: [['Risk', 6], ['Experience', 4]], // 风险偏好 + 经验依赖
          icon: "⚡"
          },
          {
          text: "重新走一遍钓点，用更细的线组 + 更小的饵匹配鱼的活性",
          resultKey: [['Environment', 5], ['Intuition', 5]], // 环境感知 + 直觉判断
          icon: "🔍"
          },
          {
          text: "整理今日记录（时间 / 水深 / 饵型），用数据推导可能的问题点",
          resultKey: [['System', 7], ['Information', 3]], // 系统分析 + 信息收集
          icon: "📊"
          }
          ]
          },
          ...
          resultKey: [['Experience', 6], ['Conservative', 4]], // 经验依赖 + 保守策略
          icon: "📚"
          },
          {
          text: "有钓友刚发朋友圈说这里「爆护」",
          resultKey: [['Information', 6], ['Risk', 4]], // 信息收集 + 风险偏好
          icon: "📣"
          },
          {
          text: "卫星地图显示水下有沟坎 / 陡崖等复杂结构",
          resultKey: [['System', 5], ['Environment', 5]], // 系统分析 + 环境感知
          icon: "🌍"
          }
          ]
          },
          ...
          {
          text: "用已知经验快速验证未知水域",
          resultKey: [['Experience', 8], ['Intuition', 2]], // 经验依赖 + 直觉判断
          icon: "✅"
          },
          {
          ...
          {
          text: "在安全范围内尽可能尝试新区域",
          resultKey: [['Explore', 6], ['Risk', 4]], // 主动探索 + 风险偏好
          icon: "🚀"
          }
          ]
          }
          ],
          // 维度权重矩阵（调整各维度对最终得分的影响系数）
          dimensionWeights: {
          Experience: 1.15, // 经验依赖
          Information: 1.3, // 信息收集
          Risk: 1.05, // 风险偏好
          Environment: 1.25, // 环境感知
          Explore: 1.2, // 主动探索
          Conservative: 1.4, // 保守策略
          Intuition: 1.45, // 直觉判断
          System: 1.3 // 系统分析
          },
          // 结果画像（8 个基础画像 + 2 个复合画像 + 1 个全能画像）
          results: [
          {
          ...
          equip: "推荐携带可快速更换配件的模块化钓组（如快换铅头钩），适应经验迁移时的灵活调整需求。"
          },
          {
          ...
          equip: "配备支持离线地图的智能钓鱼手表（如 Garmin Marq），可实时记录 / 调取钓点信息。"
          },
          {
          ...
          equip: "选择高透明度鱼线（如碳线）+ 防挂底钓组（如德州钓组），减少环境观察时的操作干扰。"
          },
          {
          ...
          equip: "选择强韧的 PE 线 + 防缠绕导环的钓竿（如 M 调以上），应对复杂水下结构的拉扯。"
          },
          {
          ...
          equip: "配备带水深探测功能的智能浮漂（如 Dr.Fish），实时修正水下结构数据。"
          },
          {
          ...
          equip: "选择通用性强的综合竿（如 28 调）+ 常见饵（如蚯蚓 / 玉米），降低陌生水域的操作难度。"
          },
          {
          ...
          equip: "选择轻量灵敏的钓竿（如 UL 调）+ 细子线，让直觉判断能通过鱼讯快速验证。"
          },
          {
          ...
          equip: "选择带数据记录功能的智能渔轮（如 Shimano Stella SW），自动记录抛投距离 / 收线速度，辅助系统分析。"
          },
          {
          ...
          equip: "选择高清晰偏光墨镜（如 Smith Optics），减少水面反光干扰，提升环境观察效率。"
          },
          {
          title: "平衡策略家（多维度均衡）",
...
const luresObsessionTest = {
            ...
            questions: [
                ...
                options: [
                  {
                    ...
                    resultKey: [['Routine', 7], ['Emotional', 3]],
                    icon: "🔁"
                  },
                  {
                    text: "调整泳层/收线速度，保持原饵",
                    resultKey: [['Consistency', 6], ['Rational', 4]],
                    icon: "⚙️"
                  },
                  {
                    text: "直接换3种不同类型新饵轮流试钓",
                    resultKey: [['Innovation', 8], ['Curiosity', 2]],
                    icon: "✨"
                  }
                ]
              },
                ...
                options: [
                  {
                    ...
                    resultKey: [['Routine', 6], ['Adaptation', 4]],
                    icon: "📦"
                  },
                  {
                    text: "观察鱼炸水位置+对比饵型匹配度",
                    resultKey: [['Observation', 7], ['Rational', 3]],
                    icon: "👀"
                  },
                  {
                    text: "尝试刚买的静音型拟饵（如微铅VIB）",
                    resultKey: [['Innovation', 5], ['Curiosity', 5]],
                    icon: "🎁"
                  }
                ]
              },
                ...
                options: [
                  {
                    ...
                    resultKey: [['Emotional', 7], ['Consistency', 3]],
                    icon: "❤️"
                  },
                  {
                    text: "检查磨损程度，磨损超20%就淘汰",
                    resultKey: [['Rational', 8], ['Observation', 2]],
                    icon: "🔍"
                  },
                  {
                    text: "改造成实验饵（如剪短尾鳍/换钩型）",
                    resultKey: [['Curiosity', 6], ['Innovation', 4]],
                    icon: "🔧"
                  }
                ]
              },
              {
                ...
                options: [
                  {
                    text: "礼貌感谢但坚持用自己的饵",
                    resultKey: [['Routine', 8], ['Emotional', 2]],
                    icon: "🙅"
                  },
                  {
                    text: "先查测评数据+对比本地鱼情再决定",
                    resultKey: [['Rational', 7], ['Observation', 3]],
                    icon: "📊"
                  },
                  {
                    text: "当场借饵试钓，晚上就下单同款",
                ...
                options: [
                  {
                    ...
                    resultKey: [['Consistency', 7], ['Routine', 3]],
                    icon: "📝"
                  },
                  {
                    text: "分析不同饵型的咬口差异数据",
                    resultKey: [['Rational', 6], ['Observation', 4]],
                    icon: "📈"
                  },
                  {
                    text: "思考未中鱼时段该用什么新饵测试",
                    resultKey: [['Innovation', 7], ['Curiosity', 3]],
                    icon: "💡"
                  }
                ]
              },
                ...
                options: [
                  {
                    ...
                    resultKey: [['Adaptation', 6], ['Routine', 4]],
                    icon: "🎒"
                  },
                  {
                    text: "先观察水生物种+模拟其天敌饵型",
                    resultKey: [['Observation', 8], ['Nature', 2]],
                    icon: "🌿"
                  },
                  {
                    text: "带5种新上市拟饵+每种试20分钟",
                    resultKey: [['Curiosity', 7], ['Innovation', 3]],
                    icon: "🔬"
                  }
                ]
              },
              {
                ...
                options: [
                  {
                    text: "宁可信其有，按老钓友经验备饵",
                    resultKey: [['Emotional', 6], ['Routine', 4]],
                    icon: "🔮"
                  },
                  {
                    text: "用3次验证无效就彻底淘汰",
            ...
            dimensionWeights: {
              Routine: 1.3,       // 惯例依赖
              Emotional: 1.1,     // 情感联结
              Consistency: 1.35,   // 持续坚持
              Rational: 1.2,      // 理性分析
              Observation: 1.2,  // 观察能力
              Innovation: 1.1,    // 创新意愿
              Curiosity: 1,    // 探索好奇
              Adaptation: 1.15    // 适应调整
            },
            results: [
              {
                title: "惯例守护者",
                ...
                equip: "推荐经典款拟饵套装（如Berkley PowerBait软虫基础套装），搭配可调节的多功能饵盒，既能保持惯例又方便小范围创新。"
              },
              {
                title: "理性调整者",
                ...
                equip: "选择带刻度的饵盒（方便记录使用次数），搭配可换钩柄的拟饵（如Keitech Easy Shiner 多钩型软虫），满足你调整优化的需求。"
              },
              {
                title: "创新探索者",
                ...
                equip: "推荐模块化拟饵套装（如Yamamoto Senko 多尺寸组合），搭配快速换饵别针（如Daiwa Cross Lock Snap），满足你高频更换的需求。"
              },
              {
                title: "观察洞察者",
                ...
                equip: "选择高可见度拟饵（如亮片带荧光涂层），搭配偏光镜（如Smith Optics 专业钓鱼镜），增强你对水面细节的捕捉能力。"
              },
              {
                title: "情感联结者",
                ...
                equip: "选择可定制的饵盒（如Plano 3700系列带姓名贴），搭配防腐蚀保养套装（如WD-40 渔具保养油），帮你更好地保存有意义的拟饵。"
              },
              {
                title: "灵活适应者",
                ...
                equip: "推荐分层饵盒（如Storm 多隔层饵盒），按鱼情类型分区存放（如上层鱼/底层鱼/活性低鱼），方便快速拿取目标饵型。"
              },
              {
                title: "平衡探索者",
                ...
                equip: "选择可扩展的饵包系统（如Frabill 防水饵包+模块化插袋），既方便携带常规饵，又能为新饵预留实验空间。"
              },
              {
                title: "综合型钓手",
...
const personality2 = {
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Rare', 6], ['Knowledge', 4]],
          icon: "🦖"
        },
        {
          text: "钓友群热议的‘爆扣点’（如翘嘴/鲈鱼高频咬口区）",
          resultKey: [['Frequency', 7], ['Experience', 3]],
          icon: "🎣"
        },
        {
          text: "地图上标红的‘未开发野河’（可能有惊喜鱼种）",
          resultKey: [['Innovation', 5], ['Adaptation', 5]],
          icon: "🗺️"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "直接选A，稀有鱼值得等待",
          resultKey: [['Rare', 1], ['Patience', 9]],
          icon: "⏳"
        },
        {
          text: "先钓B积累手感，再转A",
          resultKey: [['Frequency', 5], ['Experience', 5]],
          icon: "🔄"
        },
        {
          text: "同时布两个钓组测试效果",
          resultKey: [['Innovation', 6], ['Adaptation', 4]],
          icon: "⚙️"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Knowledge', 8], ['Rare', 2]],
          icon: "📖"
        },
        {
          text: "拍视频记录咬口瞬间发钓友群炫耀",
          resultKey: [['Frequency', 6], ['Experience', 4]],
          icon: "📱"
        },
        {
          text: "分析其攻击方式并调整拟饵策略",
          resultKey: [['Innovation', 7], ['Adaptation', 3]],
          icon: "🔍"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "复盘操作细节，调整钓组再挑战",
          resultKey: [['Rare', 5], ['Achievement', 5]],
          icon: "🔄"
        },
        {
          text: "换钓点寻找新咬口保持上鱼节奏",
        ...
        },
        {
          ...
          resultKey: [['Knowledge', 5], ['Adaptation', 5]],
          icon: "📝"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Rare', 6], ['Achievement', 4]],
          icon: "🎯"
        },
        {
          text: "经典高咬口饵（如铅头钩+卷尾蛆）",
          resultKey: [['Frequency', 6], ['Adaptation', 4]],
          icon: "🛠️"
        },
        {
          text: "新上市的概念饵（如声呐诱鱼软虫）",
          resultKey: [['Innovation', 5], ['Experience', 5]],
          icon: "💡"
        }
      ]
    },
  ...
  dimensionWeights: {
    Rare: 1.3,        // 稀有鱼种追求度
    Frequency: 1.1,   // 高频咬口偏好度
    Achievement: 2, // 成就动机强度
    Experience: 1.0,  // 过程体验重视度
    Knowledge: 1.25,   // 鱼种知识储备量
    Adaptation: 1.15,  // 环境适应能力
    Patience: 1.9,    // 耐心等待指数
    Innovation: 1.1   // 创新尝试意愿
  },
  results: [
    {
      ...
      equip: "推荐MH调慢调竿（如达瓦Zillion）+ 1000型微物轮（精准控制），搭配定制深潜米诺（模仿稀有鱼猎物），子线选择隐形碳线（降低警惕性）。"
    },
    {
      ...
      equip: "L调快调竿（如喜马诺Exage）+ 2000型纺车轮（顺滑出线），搭配经典亮片/小胖子（泛用性强），主线用低延展PE线（清晰感知咬口）。"
    },
    {
      ...
      equip: "ML调中快竿（如伽玛卡兹Airity）+ 便携鱼类测量尺，搭配仿生软饵（如仿石爬子软虫），必备防水笔记本记录生态数据。"
    },
    {
      ...
      equip: "M调中通竿（如宝熊突击者）+ 3000型鼓轮（远投稳定），搭配全水层搜索饵（如VIB+德州钓组），必备防水手机套记录环境参数。"
    },
    {
      ...
      equip: "UL调超软竿（如达瓦Sword）+ 微物水滴轮（精准抛投），搭配自制发光软饵/羽毛钩，必备便携电子秤记录实验数据。"
    },
    {
      ...
      equip: "H调暴力竿（如SHIMANO Chronarch）+ 5000型大轮（强拉力），搭配大克重米诺（针对大体型鱼），必备鱼护+氧气泵（暂养观察）。"
    },
    {
      ...
      equip: "智能钓鱼竿（如Fishbrain联名款）+ 带GPS的渔轮（记录抛投轨迹），搭配可连接APP的智能饵（实时反馈咬口力度），必备防水平板（实时查看数据）。"
    },
    {
      title: "平衡体验者（多维度均衡）",
      ...
      options: [
        {
          ...
          resultKey: [['Analyze', 5], ['Calm', 5]],
          icon: "🔍"
        },
        {
          text: "立刻拆开钓组检查钩尖锋利度/子线磨损",
          resultKey: [['Adjust', 6], ['Systematic', 4]],
          icon: "🔧"
        },
        {
          text: "把竿子砸在地上骂两句，换个更远的标点重抛",
          resultKey: [['Impulsive', 7], ['Emotional', 3]],
          icon: "🔥"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Flexible', 6], ['Nature', 4]],
          icon: "🌿"
        },
        {
          text: "换用同类型但更小号的拟饵（如7g改5g）",
          resultKey: [['Experiment', 5.5], ['Analyze', 4.5]],
          icon: "🧪"
        },
        {
          text: "完全更换钓组类型（如软饵换硬饵）",
          resultKey: [['Impulsive', 6], ['Emotional', 4]],
          icon: "🎢"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Systematic', 7], ['Data', 3]],
          icon: "📊"
        },
        {
          text: "坐在钓箱上抽根烟，观察其他钓友的操作",
          resultKey: [['Calm', 6], ['Observe', 4]],
          icon: "🚬"
        },
        {
          text: "收拾装备去5公里外的备用钓点",
          resultKey: [['Impulsive', 8], ['Action', 2]],
          icon: "🚗"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Adjust', 5], ['Collaborate', 5]],
          icon: "🤝"
        },
        {
          text: "反驳'是鱼个体太大切线'，强调装备没问题",
          resultKey: [['Emotional', 6], ['Defensive', 4]],
          icon: "🛡️"
        },
        {
          text: "默默记下这句话，下竿时刻意加力刺鱼",
          resultKey: [['Persist', 7], ['Analyze', 3]],
          icon: "💪"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Systematic', 6], ['Adjust', 4]],
          icon: "🔄"
        },
        {
          text: "把变形的钩拍下来发钓鱼群求解决方案",
          resultKey: [['Collaborate', 5.5], ['Data', 4.5]],
          icon: "📱"
        },
        {
          text: "觉得'今天运气不好'，降低作钓积极性",
          resultKey: [['Emotional', 7], ['Passive', 3]],
          icon: "😞"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Calm', 6], ['Persist', 4]],
          icon: "🎣"
        },
        {
          text: "比平时更用力刺鱼，担心再次脱钩",
          resultKey: [['Impulsive', 5], ['Overcompensate', 5]],
          icon: "⚡"
        },
        {
          text: "根据刚才跑鱼的情况动态调整手法",
          resultKey: [['Flexible', 7], ['Analyze', 3]],
          icon: "🔄"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Analyze', 6], ['Systematic', 4]],
          icon: "📝"
        },
        {
          text: "环境变量影响（如水温/风向变化）",
          resultKey: [['Nature', 7], ['Observe', 3]],
          icon: "🌤️"
        },
        {
          text: "当时的情绪状态（是否急躁/紧张）",
          resultKey: [['Calm', 5], ['Emotional', 5]],
          icon: "❤️"
        }
      ]
    }
  ...
  results: [
    {
      ...
      equip: "推荐使用模块化钓组系统（如快换别针+多规格曲柄钩套装），支持30秒内完成钩型/饵重调整，匹配你快速修正的需求。"
    },
    {
      ...
      equip: "选择带刻度的量饵尺（精确到0.5g）和防水笔记本，方便实时记录拟饵参数；搭配可追溯批次的钩具（如带生产编码的竞技钩），便于排查质量问题。"
    },
    {
      ...
      equip: "选择配色柔和的钓竿（如浅灰/米白）和缓震握把（EVA材质），降低操作时的紧张感；搭配带倒计时功能的渔轮（如Shimano部分型号），提醒自己保持节奏。"
    },
    {
      ...
      equip: "推荐使用可变档渔轮（如Daiwa的MagSeal系列），支持快速切换卸力档位；搭配多节调性钓竿（如28调+37调可切换），满足不同修正场景的需求。"
    },
    {
      ...
      equip: "选择耐用型钓组（如防咬线+加强钩），支持高频次验证；搭配可计数的渔轮（如带抛投次数统计功能），量化验证过程。"
    },
    {
      ...
      equip: "选择带温度感应的浮水饵（如部分智能拟饵），实时反馈水层温度；搭配防水型环境记录仪（如Hobo数据采集器），建立个人环境-鱼情数据库。"
    },
    {
      ...
      equip: "选择可快速展示的钓组（如透明线盒+标签标注），方便向他人讲解；搭配便携拍摄设备（如GoPro胸戴式），记录跑鱼瞬间供群友分析。"
    },
    {
      title: "均衡发展者（综合型）",
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Eco', 6], ['Future', 4]],
          icon: "🐟"
        },
        {
          text: "犹豫5秒后放回，但拍照发圈强调'主动放流'",
          resultKey: [['Emo', 5], ['Rule', 5]],
          icon: "📸"
        },
        {
          text: "检查是否受伤，若健康则暂存鱼护，收竿前看总渔获量再决定",
          resultKey: [['Prag', 7], ['Observe', 3]],
          icon: "🧺"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Rule', 8], ['Know', 2]],
          icon: "📞"
        },
        {
          text: "用最快手法简单处理伤口后轻缓放流，祈祷它能存活",
          resultKey: [['Eco', 7], ['Decide', 3]],
          icon: "🩹"
        },
        {
          text: "纠结半小时，最终用手机查法律条款后选择放流",
          resultKey: [['Know', 6], ['Observe', 4]],
          icon: "📚"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Prag', 6], ['Emo', 4]],
          icon: "🍲"
        },
        {
          text: "先放流，改去市场购买养殖鱼完成聚餐",
          resultKey: [['Eco', 7], ['Future', 3]],
          icon: "🛒"
        },
        {
          text: "询问同行钓友意见，根据多数人建议决定",
          resultKey: [['Observe', 5], ['Emo', 5]],
          icon: "👥"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Eco', 7], ['Know', 3]],
          icon: "🚫"
        },
        {
          text: "保留但不食用，用于研究记录病变特征",
          resultKey: [['Know', 6], ['Decide', 4]],
          icon: "🔬"
        },
        {
          text: "犹豫后放回，但担心影响自己今天鱼获统计",
          resultKey: [['Emo', 5], ['Prag', 5]],
          icon: "😟"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Eco', 8], ['Decide', 2]],
          icon: "🚨"
        },
        {
          text: "随他决定，但自己坚持不放流此类鱼",
          resultKey: [['Rule', 6], ['Observe', 4]],
          icon: "🤷"
        },
        {
          text: "妥协并帮忙处理，但提醒下次注意",
          resultKey: [['Emo', 7], ['Prag', 3]],
          icon: "🤝"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Rule', 7], ['Future', 3]],
          icon: "🙏"
        },
        {
          text: "快速放流但不声张，担心被他人效仿",
          resultKey: [['Observe', 6], ['Eco', 4]],
          icon: "👀"
        },
        {
          text: "保留但仅自用，认为'偶尔一次没关系'",
          resultKey: [['Prag', 5], ['Emo', 5]],
          icon: "🍴"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "改为保留并联系科研机构做标本",
          resultKey: [['Know', 7], ['Decide', 3]],
          icon: "🦴"
        },
        {
          text: "尝试人工呼吸/活水复苏后再放流",
          resultKey: [['Eco', 6], ['Emo', 4]],
          icon: "💨"
        },
        {
          text: "直接放回，认为'听天由命'",
          resultKey: [['Prag', 5], ['Observe', 5]],
          icon: "🌊"
        }
      ]
    }
  ...
  results: [
    {
      ...
      equip: "推荐无倒刺三本钩（减少鱼体损伤）+ 便携电子测鱼尺（精准判断尺寸）+ 防水记录板（实时记录放流信息）。"
    },
    {
      ...
      equip: "推荐多用软饵（减少鱼体伤害，便于放流）+ 小型保冷箱（保留时确保食材新鲜）+ 折叠取钩器（快速摘钩降低应激）。"
    },
    {
      ...
      equip: "推荐带法律条款速查功能的钓鱼APP（绑定智能手表提醒）+ 防水法律手册（装在钓箱夹层）+ 高清鱼种识别卡（快速确认保护物种）。"
    },
    {
      ...
      equip: "推荐微距摄影渔获夹（拍摄鱼体细节）+ 电子温度计（测量放流水温）+ 透明放生袋（观察放流后游动状态）。"
    },
    {
      ...
      equip: "推荐仿生活体饵（减少鱼的应激反应）+ 软木握把钓竿（提升持竿舒适度，延长作钓耐心）+ 卡通标识放生网（增加放流仪式感）。"
    },
    {
      ...
      equip: "推荐带GPS定位的智能鱼护（记录放流位置）+ 可回收标记贴（安全固定在鱼鳍）+ 水下摄像头（观察放流后鱼群反应）。"
    },
    {
      ...
      equip: "推荐多型号控鱼器（适应不同尺寸鱼体）+ 可折叠量尺（快速确认是否达标）+ 双仓鱼护（区分保留与放流鱼）。"
    },
    {
      ...
      equip: "推荐医用级取钩钳（消毒处理）+ 便携水质检测仪（快速判断放流水质）+ 防水急救包（含鱼用复苏工具）。"
    },
    {
      title: "均衡体验者（均衡得分）",
...
const socialSharingTest = {
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Cooperation', 6], ['Altruism', 4]],
          icon: "📢"
        },
        {
          text: "仅告诉3-5个长期互信的钓友",
          resultKey: [['Community', 5], ['Curiosity', 5]],
          icon: "👥"
        },
        {
          text: "用虚拟定位发朋友圈暗示，实际地点保密",
          resultKey: [['Privacy', 7], ['Security', 3]],
          icon: "🔒"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Altruism', 6.5], ['Recognition', 3.5]],
          icon: "📹"
        },
        {
          text: "只说「选7克VIB搜结构」等基础信息",
          resultKey: [['Community', 5], ['Cooperation', 5]],
          icon: "💬"
        },
        {
          text: "以「秘密武器不能说」礼貌拒绝",
          resultKey: [['Competition', 6], ['Privacy', 4]],
          icon: "🙅"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Recognition', 7], ['Altruism', 3]],
          icon: "📍"
        },
        {
          text: "风景照遮挡钓点特征+配文「野钓快乐」",
          resultKey: [['Privacy', 5.5], ['Community', 4.5]],
          icon: "🏞️"
        },
        {
          text: "仅私发给3个核心钓友+叮嘱保密",
          resultKey: [['Security', 6], ['Cooperation', 4]],
          icon: "📥"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Cooperation', 7], ['Community', 3]],
          icon: "🌱"
        },
        {
          text: "删除原分享并设置「仅自己可见」",
          resultKey: [['Security', 6], ['Privacy', 4]],
          icon: "🗑️"
        },
        {
          text: "私下联系当地渔政反映情况",
          resultKey: [['Altruism', 5], ['Curiosity', 5]],
          icon: "📞"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Community', 8], ['Recognition', 2]],
          icon: "⏳"
        },
        {
          text: "遇到有价值内容（如特殊鱼情）才分享",
          resultKey: [['Altruism', 6], ['Cooperation', 4]],
          icon: "💡"
        },
        {
      ...
      options: [
        {
          ...
          resultKey: [['Recognition', 6], ['Cooperation', 4]],
          icon: "💬"
        },
        {
          text: "直接拉黑评论者并隐藏该条分享",
          resultKey: [['Competition', 5], ['Privacy', 5]],
          icon: "🚫"
        },
        {
          text: "修改原帖增加「天气/时段」注意事项",
          resultKey: [['Curiosity', 7], ['Community', 3]],
          icon: "📝"
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          text: "以「近期鱼口差」为由婉拒",
          resultKey: [['Security', 5], ['Privacy', 5]],
          icon: "🙏"
        },
        {
          text: "先带他去其他普通钓点试探人品",
          resultKey: [['Competition', 4], ['Curiosity', 6]],
          icon: "🔍"
        }
      ]
    }
  ...
  dimensionWeights: {
    Cooperation: 1.45,    // 合作倾向
    Competition: 1.4,    // 竞争心理
    Altruism: 1.25,       // 利他精神
    Privacy: 1.5,        // 隐私意识
    Community: 1.75,      // 社群归属感
    Recognition: 1.4,   // 认同需求
    Security: 1.55,      // 安全顾虑
    Curiosity: 1.5      // 探索欲
  },
  results: [
    {
      ...
      equip: "推荐带4K防抖的运动相机（如GoPro HERO11），方便记录作钓过程；配备防水笔记本，随时记录可分享的技巧细节。"
    },
    {
      ...
      equip: "选择隐蔽性强的钓具（如迷彩涂装钓箱）；使用位置打码APP（如美图秀秀「模糊定位」），保护核心钓点信息。"
    },
    {
      ...
      equip: "推荐多接口的移动电源（保证拍摄设备续航）；使用钓鱼专用修图APP（如FishAngler），快速生成专业分享图。"
    },
    {
      ...
      equip: "选择轻量化竞技钓竿（如达瓦Zillion），满足快速作钓需求；配备防水密码盒，存放核心钓点笔记。"
    },
    {
      ...
      equip: "推荐可调节角度的鱼竿支架（方便拍摄教学画面）；使用专业录音设备（如罗德VideoMic），保证讲解清晰度。"
    },
    {
      ...
      equip: "推荐带GPS轨迹记录的智能手表（如佳明EPIX），方便验证钓点热度；使用便签贴纸记录「分享测试期」，提醒自己跟进效果。"
    },
    
    {
      ...
      equip: "推荐带时间戳的相机（如索尼A7C II），方便记录分享前后的钓点变化；使用思维导图APP（如XMind），整理分享策略逻辑。"
    },
    {
      title: "平衡分享者（多维度均衡）",
...
const fishingComparisonTest = {
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Achievement', 6], ['Selfidentity', 4]],
          icon: "😣"
        },
        {
          text: "主动观察对方的操作，默默记录拟饵和抛投频率",
          resultKey: [['Competition', 5], ['Growthmindset', 5]],
          icon: "🔍"
        },
        {
          text: "扫一眼后继续专注自己的节奏，觉得鱼情随时会变",
          resultKey: [['Detachment', 7], ['Enjoyment', 3]],
          icon: "🌿"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "减少和他同行，避免对比压力",
          resultKey: [['Selfidentity', 7], ['Socialcomparison', 3]],
          icon: "🚫"
        },
        {
          text: "私下加练拟饵操控技巧，下次要'翻盘'",
          resultKey: [['Achievement', 5], ['Resilience', 5]],
          icon: "💪"
        },
        {
          text: "和他交流心得，互相分享经验",
          resultKey: [['Growthmindset', 6], ['Enjoyment', 4]],
          icon: "🤝"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Socialcomparison', 6], ['Selfidentity', 4]],
          icon: "👍"
        },
        {
          text: "请教具体钓点和用饵，计划下周去验证",
          resultKey: [['Competition', 4], ['Growthmindset', 6]],
          icon: "📝"
        },
        {
          text: "调侃'这得请我喝奶茶'，顺便发自己的'空军'照",
          resultKey: [['Detachment', 5], ['Enjoyment', 5]],
          icon: "😄"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "和上次自己的记录比是否进步",
          resultKey: [['Achievement', 8], ['Resilience', 2]],
          icon: "📈"
        },
        {
          text: "和同行所有人的数量/大小排名",
          resultKey: [['Competition', 7], ['Socialcomparison', 3]],
          icon: "🏆"
        },
        {
    ...
    },
    {
      ...
      options: [
        {
          text: "'侥幸，可能你钓点鱼少'",
          resultKey: [['Selfidentity', 5], ['Detachment', 5]],
          icon: "🙊"
        },
        {
          text: "'我用了新拟饵，确实比之前有效'",
          resultKey: [['Achievement', 6], ['Growthmindset', 4]],
          icon: "💡"
        },
        {
          text: "'钓鱼不就图个乐，多几条少几条无所谓'",
          resultKey: [['Enjoyment', 7], ['Detachment', 3]],
          icon: "🌞"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Selfidentity', 6], ['Socialcomparison', 4]],
          icon: "😰"
        },
        {
          text: "分析水层/光线差异，调整搜索策略",
          resultKey: [['Competition', 5], ['Resilience', 5]],
          icon: "🧪"
        },
        {
      ...
      options: [
        {
          ...
          resultKey: [['Achievement', 7], ['Resilience', 3]],
          icon: "🔥"
        },
        {
          text: "去大家都说难钓的地方，挑战高难度目标鱼",
          resultKey: [['Competition', 6], ['Growthmindset', 4]],
          icon: "🎯"
        },
        {
          text: "找个风景好的野塘，有口就钓，没口当踏青",
          resultKey: [['Enjoyment', 8], ['Detachment', 2]],
          icon: "🏞️"
        }
      ]
    }
  ...
  dimensionWeights: {
    Achievement: 1.2,       // 成就动机
    Selfidentity: 1.1,      // 自我认同
    Competition: 1.3,       // 竞争意识
    Resilience: 1.65,        // 心理韧性
    Detachment: 1.1,        // 超然度
    Socialcomparison: 1.2,  // 社会比较倾向
    Growthmindset: 1.65,     // 成长型思维
    Enjoyment: 1.3          // 过程享受
  },
  results: [
    {
      ...
      equip: "推荐1662ML调直柄竿（精准抛投+控饵）+ 2000型纺车轮（顺滑卸力），搭配计数铅头钩（可量化搜索水层），满足你对技术验证的需求。"
    },
    {
      ...
      equip: "推荐模块化钓箱（多隔层收纳实验饵）+ 防水笔记本（记录实时观察），搭配变色软饵（水温变化显色，辅助分析鱼层），满足你对数据收集的需求。"
    },
    {
      ...
      equip: "推荐37调溪流竿（手感轻盈）+ 竹制鱼护（减少对鱼体损伤），搭配仿生昆虫拟饵（贴近自然生态），契合你'轻结果、重体验'的需求。"
    },
    {
      ...
      equip: "推荐定制握把钓竿（刻有个人钓龄/里程碑）+ 可记录的电子鱼护（统计单尾重量而非总数），通过具象化的'个人成就'强化自我认同。"
    },
    {
      ...
      equip: "推荐M调枪柄竿（暴力回鱼）+ 1000型水滴轮（精准抛投），搭配带荧光涂层的VIB（深水区快速搜索），满足你对'高效上鱼'的竞争需求。"
    },
    {
      ...
      equip: "推荐28调综合竿（兼顾控鱼与感知）+ 双卸力渔轮（应对不同鱼情），搭配多色T尾蛆（快速切换饵色测试鱼口），满足你对'灵活调整'的需求。"
    },
    {
      ...
      equip: "推荐便携折叠钓椅（方便围坐交流）+ 多口袋钓包（分装拟饵分享），搭配经典米诺（普适性强，适合推荐给新手），契合你'重分享'的社交需求。"
    },
    {
      ...
      equip: "推荐低调哑光配色钓具（避免刻意展示）+ 微型望远镜（远距离观察），搭配透明鱼线（减少对鱼群的干扰），符合你'隐而不发'的观察风格。"
    },
    {
...
const patienceTest = {
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Patience',6], ['Focus',4]],
          icon: "🎣"
        },
        {
          text: "更换3种不同水层/泳姿的拟饵测试",
          resultKey: [['Creativity',5.5], ['Strategic',4.5]],
          icon: "🔄"
        },
        {
          text: "收拾装备前往500米外新标点",
          resultKey: [['Adaptability',7], ['Anxiety',3]],
          icon: "🚶"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Routine',6.5], ['Strategic',3.5]],
          icon: "📝"
        },
        {
          text: "听轻音乐+做深呼吸保持节奏",
          resultKey: [['Resilience',7], ['Focus',3]],
          icon: "🎶"
        },
        {
          text: "刷钓鱼APP看别人爆护视频",
          resultKey: [['Anxiety',5], ['Adaptability',5]],
          icon: "📱"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "继续按原计划搜索剩余水域",
          resultKey: [['Patience',7], ['Routine',3]],
          icon: "🛑"
        },
        {
          text: "观察他的操作后微调自己的手法",
          resultKey: [['Observe',6], ['Creativity',4]],
          icon: "👀"
        },
        {
          text: "立刻模仿他的钓组和抛投角度",
          resultKey: [['Adaptability',5.5], ['Anxiety',4.5]],
          icon: "➡️"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Resilience',6], ['Focus',4]],
          icon: "⏳"
        },
        {
          text: "用最后一竿尝试从未用过的极端饵",
          resultKey: [['Creativity',7], ['Strategic',3]],
          icon: "🎲"
        },
        {
          text: "提前收竿并发朋友圈自嘲",
    ...
    },
    {
      ...
      options: [
        {
          text: "调整钓棚深度+放缓收线速度",
          resultKey: [['Strategic',6.5], ['Routine',3.5]],
          icon: "🔧"
        },
        {
          text: "静坐观察15分钟等环境稳定",
          resultKey: [['Patience',7], ['Resilience',3]],
          icon: "🛌"
        },
        {
          text: "直接转移到背风湾子新标点",
          resultKey: [['Adaptability',6], ['Anxiety',4]],
          icon: "🚣"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "平静解线+记录该区域结构特征",
          resultKey: [['Focus',6], ['Observe',4]],
          icon: "📌"
        },
        {
          text: "短暂懊恼+换同类型饵继续",
          resultKey: [['Resilience',5.5], ['Patience',4.5]],
          icon: "😤"
        },
        {
          text: "烦躁检查所有钓组并考虑换点",
          resultKey: [['Anxiety',7], ['Adaptability',3]],
          icon: "😠"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "坚持完成当前区域的系统搜索",
          resultKey: [['Routine',6], ['Patience',4]],
          icon: "🚫"
        },
        {
          text: "约定15分钟后如果无口再一起转移",
          resultKey: [['Strategic',5.5], ['Resilience',4.5]],
          icon: "⏱️"
        },
        {
          text: "立刻收拾装备加入换点队伍",
  ...
  dimensionWeights: {
    Patience: 1.6,      // 持久耐力
    Focus: 1.68,         // 注意力控制
    Adaptability: 1.35, // 环境适应力
    Anxiety: 1.1,       // 焦虑倾向（反向维度）
    Routine: 1.55,      // 常规坚持度
    Creativity: 1.78,    // 创新调整力
    Resilience: 1.84,   // 情绪恢复力
    Strategic: 1.48,      // 策略规划力
    Observe: 1.85        // 观察分析力
  },
  results: [
    {
      ...
      equip: "推荐MH调2.1米中长竿+1000型微物轮（出线更顺滑），搭配半浮水铅笔（可观察泳姿变化），细线（0.8PE+2号前导）保证信号传导。"
    },
    {
      ...
      equip: "选择快调ML调1.98米竿（便于频繁更换饵重），搭配2000型高速比轮（快速回收测试不同水层），装备多格饵盒（分类存放5-15g不同类型拟饵）。"
    },
    {
      ...
      equip: "推荐L调1.8米短竿（便于快速收拾），搭配折叠钓箱（收纳更便捷），使用单肩饵包（取饵换饵更快），主线选择易切线的低延展线（减少挂底损失）。"
    },
    {
      ...
      equip: "选择高感度的碳纤竿（如46T以上）+陶瓷导环（减少摩擦噪音），搭配记忆棉握把（长时间握竿不疲劳），使用荧光竿稍（弱光环境保持专注）。"
    },
    {
      ...
      equip: "选择经典款钓竿（如达瓦波纹鲤）+稳定顺滑的纺车轮（如西马诺Sedona），使用常用的「黄金饵组合」（如7g亮片+5cm软虫），减少装备变化干扰。"
    },
    {
      ...
      equip: "选择F调2.0米竿（清晰感知饵的动作），搭配微物轮（精确控制饵的泳层），装备微距摄影相机（记录饵在水中的真实状态），使用可拆解饵（方便改造）。"
    },
    {
      ...
      equip: "选择重心靠后的平衡竿（减少持竿疲劳），搭配双轴承渔轮（摇轮更省力），使用防紫外线的钓伞（保持舒适环境），佩戴运动手环（监测心率保持平稳）。"
    },
    {
      title: "多维平衡者（综合型）",
...
resultKey: [['DetailOriented',6], ['Optimistic',4]],
icon: "🎣"
},
{
text: "当时天气闷热但突然起风的转折点 + 鱼咬钩的瞬间惊喜",
resultKey: [['Contextual',5.5], ['Emotional',4.5]],
icon: "🌤️"
},
{
text: "之前试了 5 种饵都空军，最后换 VIB 才奏效的过程",
resultKey: [['Reflective',7], ['Improvement',3]],
icon: "🔄"
}
]
},
...
resultKey: [['Achievement',6.5], ['DetailOriented',3.5]],
icon: "📸"
},
{
text: "背景里有只白鹭飞过 + 对岸的芦苇荡随风摆动",
resultKey: [['Contextual',7], ['Nature',3]], // 注：原 Nature 维度已删除，调整为 Contextual+Emotional（后续统一修正）
icon: "🦢"
},
{
text: "当时用的纺车轮出线有卡顿，现在同款轮已升级改进",
resultKey: [['Improvement',5], ['Reflective',5]],
icon: "🛠️"
}
]
},
...
resultKey: [['Generalization',6], ['Reflective',4]],
icon: "📚"
},
{
text: "那天和钓友边等鱼边聊装备，反而更开心",
resultKey: [['Emotional',7], ['Contextual',3]], // 修正：原 Casual 替换为 Contextual
icon: "👥"
},
{
text: "当时固执用硬饵没换软虫，这个错误现在绝不会犯",
resultKey: [['Improvement',8], ['DetailOriented',2]],
icon: "🚫"
}
]
},
...
resultKey: [['Optimistic',7], ['Achievement',3]],
icon: "🌟"
},
{
text: "前一周每天看攻略研究标点 + 当天凌晨 4 点出发的坚持",
resultKey: [['Reflective',5.5], ['Improvement',4.5]],
icon: "⏳"
},
{
text: "钓获后和父亲视频分享 + 他说 ' 和我当年一样 ' 的温暖",
resultKey: [['Emotional',6], ['Contextual',4]], // 修正：原 Contextual 维度保留
icon: "📱"
}
]
},
...
resultKey: [['Improvement',7], ['Reflective',3]],
icon: "⚠️"
},
{
text: "当时太激动扬竿过猛 + 现在抛投时会刻意控制力度",
resultKey: [['DetailOriented',6], ['Generalization',4]],
icon: "🎯"
},
{
text: "虽然跑了鱼，但之后在同一个标点钓到更大的",
resultKey: [['Optimistic',8], ['Achievement',2]],
icon: "🔄"
}
]
},
...
resultKey: [['DetailOriented',6.5], ['Generalization',3.5]],
icon: "📊"
},
{
text: "当天的天气心情 + 和谁一起钓的趣闻",
resultKey: [['Emotional',7], ['Contextual',3]], // 修正：原 Contextual 维度保留
icon: "📖"
},
{
text: "哪些操作有效 / 无效 + 下次改进方向",
resultKey: [['Reflective',5], ['Improvement',5]],
icon: "🔍"
}
]
},
...
resultKey: [['Reflective',6], ['Generalization',4]],
icon: "💡"
},
{
text: "那次确实幸运，但更多时候空军没人看到",
resultKey: [['Emotional',5.5], ['Contextual',4.5]], // 修正：原 Contextual 维度保留
icon: "🙂"
},
{
text: "谢谢！钓鱼本来就是和自然互动，开心最重要",
resultKey: [['Optimistic',7], ['Contextual',3]], // 修正：原 Casual 替换为 Contextual
icon: "😊"
}
]
}
...
dimensionWeights: {
Optimistic: 1.35, // 乐观偏向：强化成功体验
Reflective: 1.25, // 反思倾向：分析过程得失
DetailOriented: 1.45, // 细节聚焦：关注具体操作
Emotional: 1.45, // 情感渲染：记忆情绪色彩
Achievement: 1.35, // 成就强化：突出成果价值
Improvement: 1.25, // 改进驱动：导向未来提升
Contextual: 1.4, // 情境还原：关联环境背景
Generalization: 1.55 // 经验泛化：提炼普适规律
},
results: [
{
...
equip: "推荐带防水功能的运动相机（如 GoPro Hero 12），可实时记录中鱼瞬间的细节，帮助你更客观地回顾成功操作。"
},
{
...
equip: "推荐多节可换导环的钓竿（如 Shimano Expride），方便你测试不同导环配置对抛投的影响，将反思转化为实际改进。"
},
{
...
equip: "推荐带刻度的量鱼尺（如 Daiwa Digital Caliper），配合防水笔记本（Rite in the Rain），帮助你系统记录鱼体大小、水深等关键数据。"
},
{
title: "情感共鸣者（Emotional+Contextual）", // 修正：原 Casual 替换为 Contextual
description: "你的回忆是部情感电影 —— 和钓友的玩笑、等鱼时的微风、跑鱼后的大笑比鱼获本身更深刻。钓鱼对你而言是社交与放松的载体，这种心态让你享受过程，但可能对技术提升不够主动。",
formula: "(Emotional+Contextual)>=40", // 修正：维度匹配
suggestion: "尝试参与 1-2 次钓鱼主题活动（如夜钓派对），在保持轻松心态的同时，通过社交自然吸收他人经验，实现 ' 快乐中进步 '。",
equip: "推荐轻便透气的钓鱼马甲（如 Simms G3 Guide Vest），口袋设计方便携带零食和手机，让你在作钓时更轻松地与同伴互动。"
},
{
...
equip: "推荐多类型拟饵套装（如 Lucky Craft 综合软饵包），方便你测试不同饵型在相同水情下的效果，验证经验模型的普适性。"
},
{
...
equip: "推荐带 GPS 定位的钓鱼手表（如 Garmin Marq Fishing），自动记录钓点坐标和环境数据，帮助你将情境记忆与具体参数关联。"
},
{
...
equip: "推荐声音诱鱼拟饵（如 Rapala X-Rap），其声波设计与你的直觉记忆模式契合，能增强你对 ' 有效信号 ' 的感知。"
},
{
...
const personalityTest1 = {
  ...
  questions: [
      ...
      options: [
        {
          ...
          resultKey: [['Achievement', 6], ['Skill', 4]],
          icon: "🎯"
        },
        {
          text: "钓点风景与环境舒适度（如溪流/湖景）",
          resultKey: [['Relaxation', 7], ['Nature', 3]],
          icon: "🏞️"
        },
        {
          text: "尝试新钓法的机会（如雷强/飞蝇路亚）",
          resultKey: [['Experiment', 5], ['Selfrealization', 5]],
          icon: "🔬"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Tactics', 7], ['Achievement', 3]],
          icon: "📊"
        },
        {
          text: "收竿找个树荫喝茶，观察水鸟/植物放松",
          resultKey: [['Relaxation', 6], ['Nature', 4]],
          icon: "🍵"
        },
        {
          text: "翻出冷门拟饵（如波趴+胡须佬组合）试钓",
          resultKey: [['Experiment', 8], ['Selfrealization', 2]],
          icon: "🎣"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Skill', 8], ['Tactics', 2]],
          icon: "🔍"
        },
        {
          text: "外观设计与握感（如手绘涂装/人体工学握把）",
          resultKey: [['Relaxation', 5], ['Social', 5]],
          icon: "🎨"
        },
        {
          text: "创新设计与独特功能（如声呐诱鱼/变色涂层）",
          resultKey: [['Experiment', 6], ['Selfrealization', 4]],
          icon: "✨"
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          text: "思考如何突破现有中鱼率记录",
          resultKey: [['Achievement', 5], ['Selfrealization', 5]],
          icon: "📈"
        }
      ]
    },
    {
      ...
      options: [
        {
          text: "证明技术实力的核心舞台",
          resultKey: [['Achievement', 8], ['Social', 2]],
          icon: "🏆"
        },
        {
          text: "认识同好/分享趣事的社交场合",
          resultKey: [['Social', 7], ['Relaxation', 3]],
          icon: "👥"
        },
        {
          text: "测试新战术/拟饵的实验基地",
          resultKey: [['Tactics', 6], ['Experiment', 4]],
          icon: "🧪"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Achievement', 7], ['Skill', 3]],
          icon: "📸"
        },
        {
          text: "身心放松的程度（是否忘记工作压力）",
          resultKey: [['Relaxation', 8], ['Nature', 2]],
          icon: "💆"
        },
        {
          text: "学到的新经验（如某种结构藏鱼规律）",
          resultKey: [['Selfrealization', 6], ['Experiment', 4]],
          icon: "📚"
        }
      ]
    },
      ...
      options: [
        {
          ...
          resultKey: [['Skill', 6], ['Achievement', 4]],
          icon: "🚀"
        },
        {
          text: "亲近自然的治愈感（如晨雾中的水面）",
          resultKey: [['Nature', 7], ['Relaxation', 3]],
          icon: "🌿"
        },
        {
          text: "持续探索的乐趣（如发现新标点）",
  ...
  dimensionWeights: {
    Achievement: 1.2,    // 成就导向
    Relaxation: 1.35,     // 放松需求
    Nature: 1.55,         // 自然联结
    Tactics: 1.4,        // 战术思维
    Social: 1.55,        // 社交属性
    Experiment: 1.3,    // 探索实验
    Skill: 1.15,         // 技能追求
    Selfrealization: 1.4// 自我实现
  },
  results: [
    {
      ...
      equip: "推荐Shimano Metanium DC水滴轮（精准控线）+G.Loomis IMX-Pro钓竿（高感度），搭配VMC三本钩（强拉力）提升中鱼率。"
    },
    {
      ...
      equip: "推荐DAIWA EXIST LT纺车轮（轻量静音）+FUJI 竹纹握把钓竿（亲肤触感），搭配手工木质拟饵（自然质感）。"
    },
    {
      ...
      equip: "推荐13 Fishing Omen Black钓竿（高灵敏度传导结构信号）+Lew's Tournament Pro水滴轮（稳定抛投），搭配Z-Man T-rig软饵（精准落底）。"
    },
    {
      ...
      equip: "推荐Pflueger President纺车轮（易操作适合分享）+Okuma Celilo钓竿（多色可选），搭配色彩鲜艳的Dobyns拟饵（拍照上镜）。"
    },
    {
      ...
      equip: "推荐Abu Garcia Revo SX水滴轮（耐造适合频繁换饵）+St. Croix Mojo Bass钓竿（通用调性），搭配DIY拟饵（如3D打印自定义造型）。"
    },
    {
      ...
      equip: "推荐Daiwa Tatula LT水滴轮（细腻手感）+FUJI 碳纤导环钓竿（减少对鱼线的伤害），搭配手工绑制的飞蝇饵（体现自然尊重）。"
    },
    {
      ...
      equip: "推荐Okuma Cedros II纺车轮（轻量便携）+KastKing Royale Legend钓竿（优雅涂装），搭配手工绘制的浮水米诺（兼具美感与实用性）。"
    },
    {
      title: "全能成长者（多维度均衡）",
...
questions: [
    ...
    options: [
      {
        ...
        resultKey: [['Consciousness', 6], ['Practice', 4]],
        icon: "♻️"
      },
      {
        text: "简单打包但未分类，统一丢入垃圾桶",
        resultKey: [['Practice', 5], ['Habit', 5]],
        icon: "🗑️"
      },
      {
        text: "直接丢弃或留给场地保洁处理",
        resultKey: [['Selfdiscipline', 3], ['Rationality', 7]],
        icon: "🚮"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Influence', 7], ['Cognition', 3]],
        icon: "⚠️"
      },
      {
        text: "拍照留存并通过官方渠道举报",
        resultKey: [['Rationality', 6], ['Consciousness', 4]],
        icon: "📱"
      },
      {
        text: "装作没看见继续专注自己作钓",
        resultKey: [['Selfdiscipline', 2], ['Empathy', 8]],
        icon: "🙈"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Empathy', 6], ['Consciousness', 4]],
        icon: "🌱"
      },
      {
        text: "普通拟饵但重复使用至破损",
      ...
      {
        text: "一次性活饵（如蚯蚓/小鱼）",
        resultKey: [['Rationality', 7], ['Selfdiscipline', 3]],
        icon: "🐛"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "严格用测量尺确认法定最小尺寸",
        resultKey: [['Cognition', 7], ['Practice', 3]],
        icon: "📏"
      },
      {
        text: "凭经验判断大致符合即放流",
        resultKey: [['Habit', 6], ['Consciousness', 4]],
        icon: "👀"
      },
      {
        text: "为鱼获量偶尔放宽尺寸要求",
        resultKey: [['Selfdiscipline', 2], ['Rationality', 8]],
        icon: "🎣"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "定期组织或主动报名参与",
        resultKey: [['Influence', 6], ['Practice', 4]],
        icon: "👥"
      },
      {
        text: "偶尔参加朋友邀请的活动",
        resultKey: [['Consciousness', 5], ['Empathy', 5]],
        icon: "🎉"
      },
      {
        text: "从未参与且无计划",
    ...
    options: [
      {
        ...
        resultKey: [['Cognition', 7], ['Influence', 3]],
        icon: "🌍"
      },
      {
    ...
    options: [
      {
        ...
        resultKey: [['Consciousness', 6], ['Empathy', 4]],
        icon: "📸"
      },
      {
        text: "取少量食用（≤2斤）其余放流",
...
dimensionWeights: {
  Consciousness: 1.3,   // 环保意识强度
  Practice: 1.4,        // 行为执行力度
  Cognition: 1.2,       // 环保知识深度
  Selfdiscipline: 1.6,  // 自我约束能力
  Influence: 1.25,      // 他人带动作用
  Empathy: 1.25,        // 对生态的共情能力
  Rationality: 0.9,     // 利弊权衡理性
  Habit: 1.35           // 行为习惯稳定性
},
results: [
  {
    ...
    equip: "推荐可折叠分类垃圾袋（区分可回收/不可降解）+ 便携测量尺（精准执行‘留大放小’）"
  },
  {
    ...
    equip: "选择带有环保认证的钓具（如FSC认证木质握把钓竿）+ 可重复填充的饵盒（减少一次性包装）"
  },
  {
    title: "生态共情者（Empathy）",
    ...
    equip: "推荐无倒刺钩（降低鱼体损伤）+ 放流网（减少徒手接触鱼体）"
  },
  {
    ...
    equip: "便携法规手册（防水防撕）+ 生态科普贴纸（贴于钓箱提醒自己和他人）"
  },
  {
    ...
    equip: "多功能饵盒（可同时装可降解饵和普通饵）+ 防水笔记本（记录环保行为与作钓结果关联）"
  },
  {
    title: "习惯固化者（Habit）",
    ...
    equip: "带分隔层的钓箱（固定放置垃圾/钓具/饵）+ 可重复使用的拟饵收纳袋（减少塑料消耗）"
  },
  {
    ...
    equip: "带锁扣的饵盒（防止误拿禁用饵）+ 防水承诺书（贴于钓竿提醒自己）"
  },
  {
    ...
    equip: "带有社群标识的环保马甲（增强身份认同）+ 便携扩音器（用于钓场科普宣传）"
  },
  {
    ...
    equip: "定制环保钓箱（印有‘知行合一’标识）+ 多功能环保工具包（含垃圾袋/测量尺/法规卡）"
  },
  {
...
questions: [
    ...
    options: [
      {
        ...
        resultKey: [['Performance', 6], ['Data', 4]],  // 修正：将Tech替换为已定义的Data维度
        icon: "⚙️"
      },
      {
      ...
      },
      {
        ...
        resultKey: [['Balance', 5], ['Practical', 5]],
        icon: "🎚️"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "立即购买（相信技术溢价）",
        resultKey: [['Performance', 7], ['Depth', 3]],  // 修正：保留已定义的Depth维度
        icon: "🚀"
      },
      {
        text: "先租试用（验证实际效果）",
        resultKey: [['Depth', 6], ['Practical', 4]],
        icon: "🔍"
      },
      {
        text: "暂时不买（现有装备足够）",
        resultKey: [['Practical', 8], ['Sustainability', 2]],
        icon: "🌱"
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        resultKey: [['Sustainability', 6], ['Durability', 4]],
        icon: "♻️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Performance', 6], ['Frequency', 4]],
        icon: "⏱️"
      },
      {
        text: "反对（经验需要高频积累）",
        resultKey: [['Frequency', 7], ['Practical', 3]],
        icon: "🚶"
      },
      {
        text: "动态平衡（视目标鱼种调整）",
        resultKey: [['Balance', 8], ['Sustainability', 2]],
        icon: "⚖️"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "直接换最新款（不愿将就）",
        resultKey: [['Performance', 5], ['Aesthetic', 5]],
        icon: "✨"
      },
      {
        text: "找师傅维修后继续用",
        resultKey: [['Durability', 7], ['Practical', 3]],
        icon: "🔧"
      },
      {
        text: "升级核心部件（如换线杯）",
        resultKey: [['Balance', 6], ['Sustainability', 4]],
        icon: "🔄"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Performance', 7], ['Depth', 3]],  // 修正：将Tech替换为已定义的Depth维度
        icon: "🤖"
      },
      {
        text: "体验区（试钓新竿轮）",
      ...
      {
        text: "环保渔具展区（可降解材料）",
        resultKey: [['Sustainability', 8], ['Aesthetic', 2]],
        icon: "🌍"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "直接购买（实用优先）",
        resultKey: [['Practical', 7], ['Balance', 3]],
        icon: "✅"
      },
      {
        text: "对比10+测评数据后决定",
        resultKey: [['Depth', 6], ['Data', 4]],
        icon: "📝"
      },
      {
        text: "坚持等目标款（不愿妥协性能）",
...
dimensionWeights: {  // 补充所有涉及的维度并确保与问题选项一致
  Performance: 1,   // 性能追求
  Frequency: 1.05,     // 频次优先
  Balance: 1.2,      // 均衡配置
  Depth: 1.1,        // 深度研究
...
results: [
  {
    ...
    formula: "Performance >= 20",  // 使用已定义的Performance维度
    suggestion: "关注装备与实际场景的匹配度，避免为冗余性能买单。参与专业钓手的装备测评分享会，获取更贴近实战的性能解读。",
    equip: "推荐高模量（46T以上）碳纤维钓竿（如Shimano Conquest）+全金属机身微物轮（Daiwa Tatula LT），搭配高精度钛合金导环，确保抛投精准度与强度。"
  },
  {
...
questions: [
    ...
    options: [
      {
        ...
        resultKey: [['Honor', 6], ['Status', 4]],
        icon: "🏆"
      },
      {
        text: "总奖金超50万+顶级赞助商装备奖励",
        resultKey: [['Prize', 7], ['Economic', 3]],
        icon: "💰"
      },
      {
        text: "能和全国TOP100钓手同场竞技交流",
        resultKey: [['Social', 5], ['Challenge', 5]],
        icon: "🤝"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Mastery', 5], ['Challenge', 5]],
        icon: "📽️"
      },
      {
        text: "升级最新款比赛专用竿轮（如Shimano Metanium MGL）",
        resultKey: [['Status', 6], ['Tech', 4]],
        icon: "⚙️"
      },
      {
        text: "组织本地钓友模拟赛+建立战术交流群",
        resultKey: [['Community', 7], ['Social', 3]],
        icon: "👥"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Honor', 7], ['Challenge', 3]],
        icon: "🔥"
      },
      {
        text: "分析对手标点数据+更换高收益拟饵组合",
        resultKey: [['Mastery', 6], ['Data', 4]],
        icon: "📊"
      },
      {
        text: "约领先选手午餐交流，请教作钓思路",
        resultKey: [['Social', 8], ['Community', 2]],
        icon: "🍴"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Ethic', 9], ['Mastery', 1]],
        icon: "🌱"
      },
      {
        text: "接受但会关注是否影响最终成绩判定",
        resultKey: [['Honor', 5], ['Prize', 5]],
        icon: "⚠️"
      },
      {
        text: "正好能和钓友讨论可持续钓法，很期待",
        resultKey: [['Enjoyment', 6], ['Community', 4]],
        icon: "💬"
      }
    ]
  },
  {
    ...
    options: [
      ...
      {
        text: "钓友群/朋友圈的互动评论",
        resultKey: [['Social', 5], ['Community', 5]],
        icon: "📱"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "研究失败数据，针对性强化短板",
        resultKey: [['Mastery', 8], ['Challenge', 2]],
        icon: "🔍"
      },
      {
        text: "转投奖金更高但难度较低的区域赛",
        resultKey: [['Prize', 6], ['Economic', 4]],
        icon: "➡️"
      },
      {
        text: "继续参赛，享受和钓友同场的快乐",
        resultKey: [['Enjoyment', 7], ['Social', 3]],
        icon: "😄"
      }
    ]
  },
  {
    ...
    options: [
      ...
      {
        text: "参赛氛围和钓鱼爱好者社群",
        resultKey: [['Community', 6], ['Social', 4]],
        icon: "🌈"
      }
    ]
  }
...
results: [
  {
    ...
    equip: "推荐Shimano Chronarch MGL竞技水滴轮+G.Loomis IMX-PRO钓竿，轻量化设计与高感度导环完美匹配竞技场景，助你精准把控每一次咬口。"
  },
  {
    title: "奖金猎人（Prize主导）",
    ...
    equip: "选择达瓦（Daiwa）Lexa CT水滴轮+伽玛卡兹（Gamakatsu）轻量化直柄竿，耐用性与性价比兼顾，降低高强度赛事中的装备损耗成本。"
  },
  {
    title: "社交达人（Social主导）",
    ...
    equip: "推荐阿布（Abu Garcia）Revo SX纺车轮+Fenwick HMG综合竿，轻便易操作，方便与钓友交换试钓，拉近互动距离。"
  },
  {
    ...
    equip: "选择ST.CROIX Legend Xtreme重雷竿+卡斯丁（KastKing）巨物轮，高强度配置应对青波、鳡鱼等大体型目标鱼，支撑极限挑战需求。"
  },
  {
    ...
    equip: "推荐GARY HOWELL签名款钓竿+SHIMANO CALCUTTA CONQUEST水滴轮，高感度碳布与精密齿轮组完美捕捉鱼讯，满足技术派对细节的极致追求。"
  },
  {
    ...
    equip: "选择Ugly Stik GX2耐用竿+Pflueger President纺车轮，皮实耐造的入门级装备，方便借给社群新手使用，降低参与门槛。"
  },
  {
    ...
    equip: "推荐SHIMANO Stella SW限量纪念版纺车轮+G.Loomis Asquith签名竿，顶级品牌+限量属性完美匹配身份象征需求，开箱即成为焦点。"
  },
  {
    ...
    equip: "推荐达瓦（Daiwa）E6002H纺车轮+美夏（MEXIA）溪流竿，轻便易携带，搭配迷彩钓箱（内置保温层）存放零食饮料，完美契合体验优先需求。"
  },
  {
    title: "多维驱动者（综合型）",
...
questions: [
    ...
    options: [
      {
        ...
        resultKey: [['Material', 6], ['Gear', 4]],
        icon: "🎣"
      },
      {
        text: "毫不犹豫选钓手指导（想知道他破解滑口鱼的秘籍）",
        resultKey: [['Skill', 7], ['Experience', 3]],
        icon: "👨🏫"
      },
      {
        text: "先查鱼竿拍卖记录+计算指导后鱼获增值，再决定",
        resultKey: [['Goal', 5], ['Theory', 5]],
        icon: "📊"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Gear', 7], ['Material', 3]],
        icon: "🚗"
      },
      {
        text: "观察鱼群游向+调整抛投角度（回忆教练教的侧抛技巧）",
        resultKey: [['Skill', 6], ['Environment', 4]],
        icon: "🎯"
      },
      {
        text: "掏出笔记本记录位置/时间/水色（为下次做数据模型）",
        resultKey: [['Theory', 5.5], ['Goal', 4.5]],
        icon: "📒"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Material', 8], ['Experience', 2]],
        icon: "🏺"
      },
      {
        text: "第二天就带去野河试钓（想感受传统钓法的魅力）",
        resultKey: [['Practice', 7], ['Environment', 3]],
        icon: "🌿"
      },
      {
        text: "拆解分析竹节结构+对比现代碳布参数（写篇技术文）",
        resultKey: [['Theory', 6], ['Skill', 4]],
        icon: "🔍"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Gear', 7], ['Goal', 3]],
        icon: "📡"
      },
      {
        text: "联系教练复盘（上次指导说的细节可能没做到）",
        resultKey: [['Skill', 6], ['Experience', 4]],
        icon: "📞"
      },
      {
        text: "坐在岸边观察水鸟/昆虫（自然信号比装备更真实）",
        resultKey: [['Environment', 8], ['Practice', 2]],
        icon: "🕊️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Material', 5], ['Practice', 5]],
        icon: "📸"
      },
      {
        text: "未开发的野河（想挑战未知鱼群）",
        resultKey: [['Environment', 7], ['Skill', 3]],
        icon: "🌊"
      },
      {
        text: "有历史鱼获数据库的收费塘（数据支撑的成功率）",
        resultKey: [['Theory', 6], ['Goal', 4]],
        icon: "📊"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "能理解（装备都买了不能空手回）",
        resultKey: [['Material', 4], ['Goal', 6]],
        icon: "⚠️"
      },
      {
        text: "坚决反对（自然生态比鱼获重要）",
        resultKey: [['Environment', 8], ['Experience', 2]],
        icon: "🌱"
      },
      {
        text: "可以用仿生窝料替代（技术解决问题）",
        resultKey: [['Skill', 7], ['Theory', 3]],
        icon: "💡"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "拍照发圈定位（展示装备与鱼获）",
        resultKey: [['Material', 6], ['Practice', 4]],
        icon: "📱"
      },
      {
        text: "测量记录后放流（研究生长规律）",
        resultKey: [['Theory', 5], ['Environment', 5]],
        icon: "📏"
      },
      {
...
dimensionWeights: {
  ...
  Skill: 1.15,       // 能力提升意愿
  Theory: 1.2,      // 理论钻研倾向
  Practice: 1.05,   // 实践操作偏好
  Gear: 1.15,       // 装备追求程度
  Experience: 1.3, // 经验传承重视度
  Environment: 1.4, // 环境感知敏感度
  Goal: 1.3         // 目标结果导向性
},
results: [
  {
    ...
    equip: "推荐G.Loomis NRX+限量款钓竿（碳布工艺标杆）、Shimano Stella SW LTD轮（收藏级防水性能），搭配手工雕刻木质饵盒。"
  },
  {
    ...
    equip: "选择Berkley Cherrywood Custom钓竿（高感度反馈技术细节）、Daiwa Tatula CT SV轮（精准抛投训练利器），搭配日本进口三本钩（提升刺鱼成功率）。"
  },
  {
    ...
    suggestion: "参与生态保护组织的'放流监测'项目，用钓鱼技能助力鱼类研究；尝试传统钓法（如七星漂），提升对自然信号的敏感度。",
    equip: "推荐Fenwick HMG轻量竿（贴近自然抛投手感）、Pflueger President轮（顺滑收线不惊鱼），搭配Yamamoto Senko软饵（仿自然饵形）。"
  },
  {
    ...
    equip: "选择Garmin Striker 4探鱼器（精准绘制水下结构）、13 Fishing Concept A轮（可记录抛投距离），搭配Rapala X-Rap系列（数据验证高通用性饵）。"
  },
  {
    ...
    equip: "推荐国产老品牌光威竹山竿（经典耐用）、狼王溪流轮（轻便易操作），搭配自制酒米窝料（延续传统打窝方式）。"
  },
  {
    ...
    equip: "选择Dobyns Fury Series钓竿（可自定义导环位置）、Abu Garcia Revo Beast轮（高强度实验测试），搭配3D打印定制拟饵（验证流体力学设计）。"
  },
  {
    ...
    equip: "选择Shimano Expride钓竿（全场景适用）、Daiwa Exist轮（性能均衡），搭配Berkley PowerBait全系列（覆盖不同鱼情）。"
  },
  {
    ...
    options: [
      {
        ...
        resultKey: [['Aesthetic', 6], ['Immersion', 4]],
        icon: "🏞️"
      },
      {
        text: "钓场难度星级+隐藏鱼种解锁条件",
        resultKey: [['Challenge', 7], ['Exploration', 3]],
        icon: "⚔️"
      },
      {
        text: "钓位预约系统+自动调漂功能说明",
        resultKey: [['Comfort', 5], ['Efficiency', 5]],
        icon: "🛋️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Aesthetic', 5], ['Novelty', 5]],
        icon: "🌩️"
      },
      {
        text: "先查历史胜率，选择天气难度匹配的时段进入",
        resultKey: [['Efficiency', 6], ['Data', 4]],
        icon: "📊"
      },
      {
        text: "暂时跳过，等常规天气钓场开放再玩",
        resultKey: [['Comfort', 7], ['Social', 3]],
        icon: "☀️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Aesthetic', 7], ['Challenge', 3]],
        icon: "🎨"
      },
      {
        text: "调用系统的'光影模拟实验室'批量测试饵型",
        resultKey: [['Exploration', 6], ['Tech', 4]],
        icon: "🔬"
      },
      {
        text: "直接切换系统推荐的'通用模式'快速上鱼",
        resultKey: [['Efficiency', 8], ['Comfort', 2]],
        icon: "⏩"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Aesthetic', 7], ['Immersion', 3]],
        icon: "🎣"
      },
      {
        text: "竿稍灵敏度参数+可自定义的抖动反馈强度",
        resultKey: [['Challenge', 6], ['Tech', 4]],
        icon: "📏"
      },
      {
        text: "是否支持与现实钓竿数据同步（长度/调性）",
        resultKey: [['Social', 5], ['Efficiency', 5]],
        icon: "🔄"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Aesthetic', 6], ['Social', 4]],
        icon: "📸"
      },
      {
        text: "研究鱼的行为模式并写攻略分享",
        resultKey: [['Exploration', 7], ['Data', 3]],
        icon: "📝"
      },
      {
        text: "截图战绩后继续挑战更高难度目标",
        resultKey: [['Challenge', 8], ['Novelty', 2]],
        icon: "🚀"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Social', 6], ['Immersion', 4]],
        icon: "👥"
      },
      {
        text: "询问对方擅长的钓法，组队挑战双人限时任务",
        resultKey: [['Challenge', 5], ['Efficiency', 5]],
        icon: "⏳"
      },
      {
        text: "礼貌拒绝，更喜欢独自探索新钓点",
        resultKey: [['Exploration', 7], ['Novelty', 3]],
        icon: "🚶"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Immersion', 6], ['Aesthetic', 4]],
        icon: "🌱"
      },
      {
        text: "计算放生奖励与时间成本，决定参与时长",
        resultKey: [['Efficiency', 5], ['Data', 5]],
        icon: "🧮"
      },
      {
        text: "暂时观望，等其他玩家反馈再做决定",
        resultKey: [['Social', 7], ['Comfort', 3]],
        icon: "👀"
      }
    ]
  }
...
results: [
  {
    ...
    equip: "推荐4K+120Hz高刷VR眼镜，确保画面流畅度；选择'手绘风格拟饵'（如渐变飞蝇饵），与钓场美学风格形成呼应。"
  },
  {
    ...
    equip: "选择'专业级操作手柄'（支持6轴感应），提升微操精度；配置'动态阻力渔轮'（模拟真实鱼的挣扎力度），增强挑战真实感。"
  },
  {
    title: "舒适体验派（Comfort+Efficiency）",
    description: "你追求钓鱼的'无痛感'，讨厌复杂操作与无效等待。自动调漂、智能找底、一键分享...系统的便利功能是你的刚需，钓鱼对你来说是放松而非修行，结果重要但过程必须舒服。",
    formula: "(Comfort*1.1 + Efficiency*1.0)>=30",
    suggestion: "关注'懒人模式'更新（如AI代抛功能），保留核心乐趣的同时减少机械操作；选择'设施完善钓场'（有遮阳棚/座椅），延长单次体验时长。",
    equip: "推荐'触控式操作平板'（界面简洁易上手）；使用'智能拟饵库'（系统根据钓场自动推荐最优饵型），降低决策成本。"
  },
  {
    ...
    equip: "选择'多人协作装备'（如可共享的诱饵盒）；配置'语音变声功能'（增加互动乐趣），但注意保持礼貌沟通。"
  },
  {
    title: "数据极客（Efficiency+Data）",
    description: "你像钓鱼界的分析师，手机里存着各种钓场胜率表、鱼种咬钩时间轴。每一次抛竿都经过数据校准，钓鱼对你来说是'概率学的实践场'，用理性击败随机性。",
    formula: "(Efficiency*1.0 + Data*1.0)>=23.5",  // 注：Data维度需在问题中补充（原问题3选项2已隐含）
    suggestion: "开发个人'钓鱼数据库'（记录天气/时间/饵型的关联数据）；参与'数据预测赛'（根据历史数据预测次日鱼获），验证分析模型。",
    equip: "使用'数据同步渔轮'（自动记录抛投距离/收线速度）；配置'AI分析插件'（实时生成'最佳策略建议'），提升决策科学性。"
  },
  {
    ...
    equip: "选择'模块化装备'（可快速更换钓竿/渔轮组件）；配置'彩蛋探测插件'（提示隐藏内容线索），提升探索效率。"
  },
  {
    ...
    equip: "选择'环境自适应拟饵'（根据水色自动调整反光度）；配置'光影感应渔线'（随光线变化显示不同颜色），增强与自然的互动感。"
  },
  {
    title: "全能体验家（综合维度）",
...
questions: [
    ...
    options: [
      {
        ...
        resultKey: [['Responsibility', 6], ['Empathy', 4]],
        icon: "🩹"
      },
      {
        text: "用非持竿手固定同伴伤处，同时尝试稳住钓线不让鱼脱钩",
        resultKey: [['Riskassessment', 5], ['Benefittrade', 5]],
        icon: "⚖️"
      },
      {
        text: "先提竿控鱼防止逃脱，完成取鱼后再处理伤口",
        resultKey: [['Impulse', 7], ['Benefittrade', 3]],
        icon: "🎣"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Empathy', 6], ['Resourceallocation', 4]],
        icon: "🤝"
      },
      {
        text: "立刻协商，评估伤势严重程度/是否有替代办法，决定谁优先使用",
        resultKey: [['Riskassessment', 5.5], ['Ruleadherence', 4.5]],
        icon: "⏳"
      },
      {
        text: "优先处理自己伤口（认为渗血更易感染）",
        resultKey: [['SelfPreservation', 6], ['Benefittrade', 4]],
        icon: "🛡️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Responsibility', 7], ['Longtermview', 3]],
        icon: "🌳"
      },
      {
        text: "快速抄网取鱼后，30秒内转移同伴",
        resultKey: [['Efficiency', 6], ['Riskassessment', 4]],
        icon: "⚡"
      },
      {
        text: "继续控鱼完成取钩，认为中暑休息即可",
        resultKey: [['Impulse', 5], ['Benefittrade', 5]],
        icon: "⏱️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Ruleadherence', 7], ['Empathy', 3]],
        icon: "🚑"
      },
      {
        text: "陪他买消毒用品，但提醒24小时内就医",
        resultKey: [['Riskassessment', 6], ['Resourceallocation', 4]],
        icon: "💊"
      },
      {
        text: "按他要求保密，认为是个人选择",
        resultKey: [['SelfPreservation', 5], ['Casual', 5]],
        icon: "🙊"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Responsibility', 8], ['Longtermview', 2]],
        icon: "🔄"
      },
      {
        text: "根据伤口严重程度调整策略（如渗血则先鱼）",
        resultKey: [['Riskassessment', 6], ['Benefittrade', 4]],
        icon: "📊"
      },
      {
        text: "刻意提醒自己别重蹈覆辙（上次先处理鱼）",
        resultKey: [['Longtermview', 7], ['Impulse', 3]], // 修复：替换SelfImprovement为Longtermview
        icon: "📈"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Resourceallocation', 7], ['Responsibility', 3]],
        icon: "🩺"
      },
      {
        text: "防割手套+快速补线组+脱钩器",
        resultKey: [['Efficiency', 6], ['Tech', 4]],
        icon: "🔧"
      },
      {
        text: "便携急救手册+哨子+保温毯",
        resultKey: [['Riskassessment', 5], ['Longtermview', 5]],
        icon: "📖"
      }
    ]
  },
  {
    ...
    options: [
      {
        text: "立即上前制止并示范正确流程",
        resultKey: [['Ruleadherence', 6], ['Empathy', 4]],
        icon: "👨🏫"
      },
      {
        text: "事后提醒风险，分享自己的经历",
        resultKey: [['Longtermview', 5], ['Riskassessment', 5]], // 修复：替换SelfImprovement为Riskassessment
        icon: "💬"
      },
      {
        text: "认为是个人选择，不干涉",
        resultKey: [['Casual', 7], ['SelfPreservation', 3]],
        icon: "🙌"
      }
    ]
  }
...
dimensionWeights: {
  Responsibility: 1.3,    // 责任意识
  Empathy: 1.2,           // 情感共情
  Riskassessment: 1.15,   // 风险评估
  Benefittrade: 1.05,     // 利益权衡
  Impulse: 0.9,           // 即时冲动
  Ruleadherence: 1.25,    // 规则遵守
  Resourceallocation: 1.1,// 资源分配
  Longtermview: 1.18      // 长期视角（修复：移除冗余的SelfImprovement，保持8维度）
},
results: [
  {
    ...
    equip: "推荐配备专业户外急救包（含止血带、无菌敷料），选择带有快速取物设计的钓包（如侧开式），确保紧急情况下30秒内取出急救用品。"
  },
  {
    title: "共情守护者（Empathy）",
    ...
    equip: "选择带有软质隔层的钓箱（可放置冰袋冷敷），搭配便携安抚工具（如降噪耳机），在处理伤情时提供更舒适的环境。"
  },
  {
    ...
    equip: "推荐智能穿戴设备（如心率监测手环），辅助判断同伴生理状态；使用带拉力显示的渔轮，实时掌握钓线受力情况，为风险评估提供数据支持。"
  },
  {
    ...
    equip: "选择带有反光条的救生衣（符合户外安全标准），配备防水规则手册（标注急救流程），用装备强化规则意识。"
  },
  {
    ...
    equip: "推荐使用可降解拟饵（减少生态影响），选择轻量化钓组（降低操作风险），用装备践行长期主义。"
  },
  {
    title: "冲动修正者（Impulse+Longtermview）", // 修复：调整维度组合
    description: "你曾因即时冲动做出过后悔的选择，但可贵的是你学会了用长期视角反思改进。现在的你既能保留对钓鱼的热情，又能在冲动与责任间踩下‘刹车’，这种成长型思维让你不断趋近更成熟的决策。",
    formula: "Impulse>=12 && Longtermview>=10", // 修复：使用存在的维度
    suggestion: "可设置‘3秒冷静期’（遇到危机先深呼吸3秒），用物理延迟对抗冲动。同时记录‘冲动决策日志’，分析触发场景并制定预防策略。",
    equip: "选择带握把防滑设计的钓竿（减少因紧张导致的误操作），使用可调节卸力的渔轮（避免因控鱼心切过度发力）。"
  },
  {
    ...
    equip: "推荐分层式急救包（主仓放常用品，副仓放备用物资），选择带标签的收纳盒（快速识别物品），提升资源调配效率。"
  },
  {
    ...
    options: [
      {
        ...
        resultKey: [['Record',5], ['Tech',3], ['Analyze',2]],
        icon: "📱"
      },
      {
        text: "在笔记本上画简易钓点图+标注鱼群活跃区域",
        resultKey: [['Detail',6], ['Routine',4]],
        icon: "📓"
      },
      {
        text: "只拍鱼获照片发朋友圈，不额外记录具体数据",
        resultKey: [['Memory',5], ['Enjoy',5]],
        icon: "📸"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Detail',8], ['Improve',2]],
        icon: "🔍"
      },
      {
        text: "拍视频后放生，仅备注'今日钓到XX鱼'关键词",
        resultKey: [['Record',5], ['Routine',5]],
        icon: "🎥"
      },
      {
        text: "拍完照放回，觉得'反正下次不一定遇到'无需记录",
        resultKey: [['Memory',6], ['Enjoy',4]],
        icon: "🐟"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Analyze',7], ['Improve',3]],
        icon: "📊"
      },
      {
        text: "按钓点分类存放记录，偶尔翻出来回忆作钓场景",
        resultKey: [['Routine',6], ['Enjoy',4]],
        icon: "🗂️"
      },
      {
        text: "觉得记录太零散，基本不回头看",
        resultKey: [['Memory',8], ['Record',2]],
        icon: "❌"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Record',5], ['Tech',5]], // Tech维度分数增加
        icon: "💻"
      },
      {
    ...
    options: [
      {
        ...
        resultKey: [['Analyze',5], ['Improve',5]],
        icon: "🔄"
      },
      {
        text: "在记录本上标记'此钓点近期需规避'并调整目标鱼种",
        resultKey: [['Record',5.5], ['Detail',4.5]],
        icon: "🚫"
      },
      {
        text: "觉得是运气问题，换个钓点继续试不查记录",
        resultKey: [['Memory',7], ['Enjoy',3]],
        icon: "🎲"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Record',6], ['Tech',2], ['Analyze',2]],
        icon: "📅"
      },
      {
        text: "回忆上次去时的情况，补充'记得水草区有口'等细节",
        resultKey: [['Detail',6], ['Memory',4]],
        icon: "🧠"
      },
      {
    ...
    options: [
      {
        ...
        resultKey: [['Routine',7], ['Record',3]],
        icon: "🔄"
      },
      {
        text: "用新工具继续记录，丢失的部分顺其自然",
        resultKey: [['Routine',5], ['Enjoy',5]],
        icon: "✅"
      },
      {
        text: "觉得麻烦，干脆停止系统记录",
        resultKey: [['Memory',6], ['Record',4]],
        icon: "🛑"
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        resultKey: [['Detail',7], ['Routine',3]],
        icon: "🔍"
      },
      {
        text: "钓鱼过程的趣味故事和风景分享",
        resultKey: [['Enjoy',8], ['Memory',2]],
        icon: "🏞️"
      }
    ]
  }
...
results: [
  {
    ...
    formula: "Record*1.1 >= 31", // 原26→32（满分约44）
    suggestion: "可尝试将记录与生态保护结合，例如记录稀有鱼种出现位置时主动模糊坐标，避免过度开发。定期备份电子记录，防止数据丢失。",
    equip: "推荐使用支持GPS定位+多维度标签的钓鱼记录APP（如Fishbrain），搭配防水蓝牙秤（可自动同步鱼获数据），户外则备防水笔记本+速干笔作为应急工具。"
  },
  {
    title: "复盘分析师（Analyze）",
  ...
  },
  {
    ...
    equip: "选择设计简洁的便携记录工具（如Moleskine防水本），搭配磁吸式钓箱记录板（可随时粘贴便签补充信息），保持记录的仪式感。"
  },
  {
    title: "记忆依赖者（Memory）",
    ...
    equip: "选择轻量化记录工具（如手机便签/钓箱贴纸），搭配录音笔（口述记录关键信息），减少记录负担。"
  },
  {
    title: "提升驱动者（Improve）",
    ...
    equip: "选择支持对比分析的记录工具（如自定义表格），搭配可调式钓竿（方便测试不同调性效果），助力技术突破。"
  },
  {
    title: "享受型钓手（Enjoy）",
    ...
    equip: "选择高颜值记录工具（如复古拍立得相机），搭配可爱钓箱贴（记录当日心情），让记录本身成为钓鱼乐趣的一部分。"
  },
  {
    title: "工具技术流（Tech）",
    description: "你是钓鱼圈的'科技达人'，从智能APP到物联网设备，总能第一时间用新技术优化记录体验。技术不是你的目的，而是让记录更高效、分析更精准的'利器'，这种'技术为我所用'的态度让你走在钓鱼记录的前沿。",
    formula: "Tech*1.3 >= 19", // 新增多个Tech得分点后可达
    suggestion: "关注钓鱼科技新品（如智能浮漂/AI鱼情分析工具），但避免过度依赖技术忽略自然观察。定期清理电子记录，保持数据的有效性。",
    equip: "推荐智能钓鱼手表（支持定位/气象/鱼获记录）+蓝牙饵盒（自动记录用饵数据），实现全流程数字化记录。"
  },
  {
    ...
    options: [
      {
        ...
        resultKey: [['Teach', 6], ['Collaborate', 4]],
        icon: "👥"
      },
      {
        text: "简单指了指对岸说'那边出鱼'，自己先开竿试钓",
        resultKey: [['Independent', 7], ['Adapt', 3]],
        icon: "🎣"
      },
      {
        text: "等他主动问'哪里好钓'，再结合自己经验回答",
        resultKey: [['Learn', 5], ['Empathy', 5]],
        icon: "🤔"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Teach', 5.5], ['Share', 4.5]],
        icon: "🎯"
      },
      {
        text: "举竿示意鱼获，喊'我用的银色VIB'，继续专注自己作钓",
        resultKey: [['Independent', 6], ['Adapt', 4]],
        icon: "🌟"
      },
      {
        text: "先溜鱼入护，再走过去问'你用的什么饵？需要我帮你看手法吗？'",
        resultKey: [['Empathy', 6], ['Collaborate', 4]],
        icon: "❤️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Teach', 7], ['Share', 3]],
        icon: "🔧"
      },
      {
        text: "直接递过去说'随便用'，继续调整自己的线组不关注他的操作",
        resultKey: [['Independent', 8], ['Adapt', 2]],
        icon: "🛠️"
      },
      {
        text: "笑着说'你要是喜欢下次借你玩'，但暂时不想出借新装备",
        resultKey: [['Learn', 4], ['Empathy', 6]],
        icon: "🙌"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Collaborate', 6], ['Adapt', 4]],
        icon: "⏳"
      },
      {
        text: "坚持自己节奏说'守钓更容易等鱼窝'，不管他是否跟随",
        resultKey: [['Independent', 7], ['Teach', 3]],
        icon: "🚧"
      },
      {
        text: "妥协说'那我跟你走钓吧，刚好试试我的远投竿'",
        resultKey: [['Empathy', 5.5], ['Learn', 4.5]],
        icon: "🤝"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Share', 6], ['Empathy', 4]],
        icon: "🎁"
      },
      {
        text: "安慰'我上周也空军三次'，但继续专注自己补窝不深入交流",
        resultKey: [['Independent', 5], ['Adapt', 5]],
        icon: "🌱"
      },
      {
        text: "收起自己的鱼护说'其实我也没口，咱们换个饵再试试？'",
        resultKey: [['Learn', 4], ['Collaborate', 6]],
        icon: "🔄"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Teach', 6.5], ['Collaborate', 3.5]],
        icon: "🎮"
      },
      {
        text: "把自己的雷强竿借他说'小心挂草'，自己继续玩软饵",
        resultKey: [['Share', 5], ['Independent', 5]],
        icon: "🎣"
      },
      {
        text: "提醒'雷强很耗体力，你确定？'，根据他的坚持程度决定是否协助",
        resultKey: [['Empathy', 6], ['Learn', 4]],
        icon: "⚠️"
      }
    ]
  },
    ...
    options: [
      {
        ...
        resultKey: [['Learn', 6], ['Share', 4]],
        icon: "💬"
      },
      {
        text: "前面有家鱼馆不错，要不要去吃？（转移话题）",
        resultKey: [['Adapt', 7], ['Independent', 3]],
        icon: "🍴"
      },
      {
        text: "你刚才抄鱼的手法很稳，是跟谁学的？（主动请教）",
        resultKey: [['Empathy', 5], ['Collaborate', 5]],
        icon: "🙋"
      }
    ]
  }
...
dimensionWeights: {
  Teach: 1.5,       // 教学意愿
  Collaborate: 1.6, // 协作倾向
  Independent: 1.2, // 独立程度
  Share: 1.45,      // 分享意愿
  Learn: 1.55,      // 学习倾向
  Empathy: 1.65,    // 共情能力
  Adapt: 1.3        // 适应能力
...
results: [
  {
    ...
    equip: "推荐带便携多格饵盒（方便展示不同饵型）+ 可调节握把的演示竿（适应不同身高同伴试用），搭配防水笔记本记录同伴问题，针对性解答更高效。"
  },
  {
    ...
    equip: "选择快拆式钓箱（方便快速转移钓点）+ 远投套装（减少频繁调整装备的干扰），搭配可单手操作的控鱼器，保持专注作钓的流畅性。"
  },
  {
    ...
    equip: "推荐带双仓钓包（自己装备+备用小物）+ 折叠马扎（方便与同伴并肩交流），搭配可挂式鱼护（展示鱼获时不遮挡视线，增加互动感）。"
  },
  {
    ...
    equip: "推荐带防水录音笔（记录同伴经验）+ 可擦写钓场地图（边讨论边标注），搭配多节式演示竿（拆解讲解结构更直观），学习工具就是你的互动武器。"
  },
  {
    ...
    equip: "选择通用型装备（如M调竿+2000型轮），方便临时借给同伴使用。搭配多口袋马甲（装小药、子线等备用物资），随时解决同伴的小需求。"
  },
  {
    ...
    equip: "推荐带可调节角度的钓鱼相机（录制教学视频）+ 多饵展示板（标注饵重/适用场景），搭配带刻度的子线板（直观演示线组长度），技术分享更有说服力。"
  },
  {
    ...
    equip: "选择轻量化装备（如28调软竿+微物轮），减少装备负担更专注体验。搭配防水日记本（记录作钓感受），学习和独立思考都需要「记录」来沉淀。"
  },
  {
